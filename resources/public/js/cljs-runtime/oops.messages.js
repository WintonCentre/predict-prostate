...
var hierarchy__4705__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__36097 = cljs.core.get_global_hierarchy;
return (fexpr__36097.cljs$core$IFn$_invoke$arity$0 ? fexpr__36097.cljs$core$IFn$_invoke$arity$0() : fexpr__36097.call(null));
})());
return (new cljs.core.MultiFn(cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("oops.messages","runtime-message"),(function() { 
var G__36233__delegate = function (type,_){
return type;
};
var G__36233 = function (type,var_args){
var _ = null;
if (arguments.length > 1) {
var G__36234__i = 0, G__36234__a = new Array(arguments.length -  1);
while (G__36234__i < G__36234__a.length) {G__36234__a[G__36234__i] = arguments[G__36234__i + 1]; ++G__36234__i;}
  _ = new cljs.core.IndexedSeq(G__36234__a,0,null);
} 
return G__36233__delegate.call(this,type,_);};
G__36233.cljs$lang$maxFixedArity = 1;
G__36233.cljs$lang$applyTo = (function (arglist__36235){
var type = cljs.core.first(arglist__36235);
var _ = cljs.core.rest(arglist__36235);
return G__36233__delegate(type,_);
});
...
var flavor = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36098__$1,new cljs.core.Keyword(null,"flavor","flavor",-1331636636));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36098__$1,new cljs.core.Keyword(null,"path","path",-188191168));
...
var soft_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36110__$1,new cljs.core.Keyword(null,"soft?","soft?",-1339668477));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36110__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36110__$1,new cljs.core.Keyword(null,"fn","fn",-1175266204));
...
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36123__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36123__$1,new cljs.core.Keyword(null,"path","path",-188191168));
...
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36150__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36150__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var frozen_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36150__$1,new cljs.core.Keyword(null,"frozen?","frozen?",613726824));
...
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36189__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36189__$1,new cljs.core.Keyword(null,"path","path",-188191168));
...
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36216__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36216__$1,new cljs.core.Keyword(null,"path","path",-188191168));
return oops.messages.post_process_message.call(null,["Cannot create object key '",cljs.core.str.cljs$core$IFn$_invoke$arity$1(key),"'",((((cljs.core.empty_QMARK_(path)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(path,key))))?null:[" on key path '",cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),"'"].join(''))," because the object is frozen"].join(''));
}));
