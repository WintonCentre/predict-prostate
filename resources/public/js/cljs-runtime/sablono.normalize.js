...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__40385){
var vec__40386 = p__40385;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40386,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40386,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__40398_SHARP_){
return (((p1__40398_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__40398_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__40423,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__40423;
}
});
...
var G__40508 = (i__4819__auto___40507 + (1));
i__4819__auto___40507 = G__40508;
continue;
} else {
}
break;
...
var G__40443 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40443,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__40443;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq40425){
var self__4806__auto__ = this;
return self__4806__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq40425));
}));
...
var vec__40464 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__40492 = cljs.core.ffirst(matches);
var fexpr__40491 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__40491.cljs$core$IFn$_invoke$arity$1 ? fexpr__40491.cljs$core$IFn$_invoke$arity$1(G__40492) : fexpr__40491.call(null,G__40492));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40464,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40464,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__40451_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__40451_SHARP_))){
return p1__40451_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__40452_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__40452_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__40499){
var vec__40500 = p__40499;
var seq__40501 = cljs.core.seq(vec__40500);
var first__40502 = cljs.core.first(seq__40501);
var seq__40501__$1 = cljs.core.next(seq__40501);
var tag = first__40502;
var content = seq__40501__$1;
...
var vec__40503 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40503,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40503,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40503,(2),null);
