...
var sablono$interpreter$IInterpreter$interpret$dyn_40528 = (function (this$){
...
return sablono$interpreter$IInterpreter$interpret$dyn_40528(this$);
}
});
...
var x40509_40533 = ctor.prototype;
(x40509_40533.onChange = (function (event){
var this$ = this;
...
(x40509_40533.componentWillReceiveProps = (function (new_props){
var this$ = this;
...
switch (G__40511) {
case "input":
var G__40512 = (function (){var and__4210__auto__ = cljs.core.object_QMARK_(props);
if(and__4210__auto__){
return props.type;
} else {
return and__4210__auto__;
...
var len__4818__auto___40556 = arguments.length;
var i__4819__auto___40557 = (0);
while(true){
if((i__4819__auto___40557 < len__4818__auto___40556)){
args__4824__auto__.push((arguments[i__4819__auto___40557]));

var G__40558 = (i__4819__auto___40557 + (1));
i__4819__auto___40557 = G__40558;
continue;
} else {
}
break;
...
/** @this {Function} */
(sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq40513){
...
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40514,G__40515,seq40513__$2);
}));
...
var vec__40519 = sablono.normalize.element(element);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40519,(0),null);
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40519,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40519,(2),null);
