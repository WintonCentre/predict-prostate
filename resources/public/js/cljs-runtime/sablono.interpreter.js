...
var sablono$interpreter$IInterpreter$interpret$dyn_40414 = (function (this$){
...
return sablono$interpreter$IInterpreter$interpret$dyn_40414(this$);
}
});
...
var x40368_40425 = ctor.prototype;
(x40368_40425.onChange = (function (event){
var this$ = this;
...
(x40368_40425.componentWillReceiveProps = (function (new_props){
var this$ = this;
...
switch (G__40382) {
case "input":
var G__40383 = ((cljs.core.object_QMARK_(props))?props.type:false);
switch (G__40383) {
case "radio":
...
args__4742__auto__.push((arguments[i__4737__auto___40438]));

var G__40439 = (i__4737__auto___40438 + (1));
i__4737__auto___40438 = G__40439;
continue;
} else {
}
break;
...
/** @this {Function} */
(sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq40386){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40387,G__40388,seq40386__$2);
}));
...
var vec__40395 = sablono.normalize.element(element);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40395,(0),null);
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40395,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40395,(2),null);
