...
var decimal = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__42767__$1,new cljs.core.Keyword(null,"decimal","decimal",-170212044),".");
var group = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__42767__$1,new cljs.core.Keyword(null,"group","group",582596132),"");
...
return clojure.string.replace(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__42760_SHARP_),".",decimal);
});
} else {
return (function (x){
var s = cljs.core.str.cljs$core$IFn$_invoke$arity$1(x);
var vec__42770 = cljs.core.re_matches(/(-?)(\d+)\.?(\d*)/,s);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42770,(0),null);
var sign = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42770,(1),null);
var integer_part = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42770,(2),null);
var fraction_part = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42770,(3),null);
...
if((idx < len)){
var G__42777 = (idx + (3));
var G__42778 = [res,cljs.core.str.cljs$core$IFn$_invoke$arity$1((((idx > (0)))?group:null)),cljs.core.subs.cljs$core$IFn$_invoke$arity$3(integer_part,idx,(idx + (3)))].join('');
idx = G__42777;
res = G__42778;
continue;
} else {
