...
var G__31151 = devtools.prefs.pref(v);
v = G__31151;
continue;
} else {
return v;
...
}catch (e31081){var _e__29962__auto__ = e31081;
return false;
}})();
...
}catch (e31088){var _e__29962__auto__ = e31088;
return false;
}})();
...
}catch (e31091){var _e__29962__auto__ = e31091;
return false;
}}
}
});
...
var vec__31104 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31104,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31104,(1),null);
...
return cljs.core.some((function (p1__31139_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__31139_SHARP_);
}),template);
});
