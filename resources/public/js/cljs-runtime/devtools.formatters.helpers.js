...
var G__31182 = devtools.prefs.pref(v);
v = G__31182;
continue;
} else {
return v;
...
}catch (e31154){var _e__30231__auto__ = e31154;
return false;
}})();
...
}catch (e31158){var _e__30231__auto__ = e31158;
return false;
}})();
...
}catch (e31162){var _e__30231__auto__ = e31162;
return false;
}}
}
});
...
var vec__31169 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31169,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31169,(1),null);
...
return cljs.core.some((function (p1__31172_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__31172_SHARP_);
}),template);
});
