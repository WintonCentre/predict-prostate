...
var vec__59628 = predict_prostate.content_reader.section.cljs$core$IFn$_invoke$arity$2(ttt,banner_id);
var seq__59629 = cljs.core.seq(vec__59628);
var first__59630 = cljs.core.first(seq__59629);
var seq__59629__$1 = cljs.core.next(seq__59629);
var _ = first__59630;
var preamble = seq__59629__$1;
...
return daiquiri.core.create_element("div",{'style':{'backgroundColor':predict_prostate.results.util.alison_blue_1,'paddingTop':(20),'paddingBottom':(20),'marginTop':(20),'marginBottom':(0)},'className':"row screen-only"},[daiquiri.core.create_element("div",{'className':"col-md-3 col-md-offset-2 text-center"},[daiquiri.core.create_element("img",{'src':"/assets/tool-icon.png",'alt':"tool-icon",'aria-hidden':true},null),(function (){var attrs59637 = (function (){var G__59641 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("fb","wtupp-title","fb/wtupp-title",-1414474898),"Want to use Predict Prostate?"], null);
return (ttt.cljs$core$IFn$_invoke$arity$1 ? ttt.cljs$core$IFn$_invoke$arity$1(G__59641) : ttt.call(null,G__59641));
})();
return daiquiri.core.create_element("h3",((cljs.core.map_QMARK_(attrs59637))?daiquiri.interpreter.element_attributes(attrs59637):null),((cljs.core.map_QMARK_(attrs59637))?null:[daiquiri.interpreter.interpret(attrs59637)]));
})(),(function (){var attrs59640 = (function (){var G__59642 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("fb","wtupp-text1","fb/wtupp-text1",-1300454758),"This tool helps to understand how treatments for prostate cancer may improve survival rates after diagnosis."], null);
return (ttt.cljs$core$IFn$_invoke$arity$1 ? ttt.cljs$core$IFn$_invoke$arity$1(G__59642) : ttt.call(null,G__59642));
})();
return daiquiri.core.create_element("p",((cljs.core.map_QMARK_(attrs59640))?daiquiri.interpreter.element_attributes(attrs59640):null),((cljs.core.map_QMARK_(attrs59640))?null:[daiquiri.interpreter.interpret(attrs59640)]));
})(),daiquiri.interpreter.interpret(predict_prostate.components.button.start_button(ttt))]),daiquiri.core.create_element("div",{'style':{'marginTop':"20px"},'className':"col-md-3 col-md-offset-2 text-center"},[daiquiri.core.create_element("img",{'src':"/assets/faq-icon.png",'alt':"faq-icon",'aria-hidden':true},null),(function (){var attrs59647 = (function (){var G__59651 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("fb","sttt-title","fb/sttt-title",-55013877),"Someone to talk to?"], null);
return (ttt.cljs$core$IFn$_invoke$arity$1 ? ttt.cljs$core$IFn$_invoke$arity$1(G__59651) : ttt.call(null,G__59651));
})();
return daiquiri.core.create_element("h3",((cljs.core.map_QMARK_(attrs59647))?daiquiri.interpreter.element_attributes(attrs59647):null),((cljs.core.map_QMARK_(attrs59647))?null:[daiquiri.interpreter.interpret(attrs59647)]));
})(),(function (){var attrs59650 = (function (){var G__59652 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("fb","sttt-text1","fb/sttt-text1",-1075642630),"If you are fighting cancer, it\u2019s often easier with support. Here, you can find further information and links."], null);
return (ttt.cljs$core$IFn$_invoke$arity$1 ? ttt.cljs$core$IFn$_invoke$arity$1(G__59652) : ttt.call(null,G__59652));
})();
return daiquiri.core.create_element("p",((cljs.core.map_QMARK_(attrs59650))?daiquiri.interpreter.element_attributes(attrs59650):null),((cljs.core.map_QMARK_(attrs59650))?null:[daiquiri.interpreter.interpret(attrs59650)]));
...
}),'className':"btn btn-danger btn-lg"},[daiquiri.interpreter.interpret((function (){var G__59654 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("fb","sl","fb/sl",1007548333),"Support Links"], null);
return (ttt.cljs$core$IFn$_invoke$arity$1 ? ttt.cljs$core$IFn$_invoke$arity$1(G__59654) : ttt.call(null,G__59654));
})())])])]);
...
return daiquiri.core.create_element("div",{'className':"row"},[daiquiri.core.create_element("div",{'className':"col-sm-10 col-sm-offset-1 col-xs-12"},[daiquiri.core.create_element("img",{'src':"/assets/NHS.jpg",'alt':"NHS logo",'style':{'width':"85px",'marginTop':"30px",'marginBottom':"38px"},'className':"img-responsive pull-right"},null),daiquiri.core.create_element("img",{'src':"/assets/prostate-angle-man_1.png",'alt':"Predict prostate logo",'style':{'width':"180px",'marginTop':"13px",'marginBottom':"6px"},'className':"img-responsive"},null)]),(function (){var attrs59658 = predict_prostate.layout.header.skip_to("#main-content");
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs59658))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["col-xs-12"], null)], null),attrs59658], 0))):{'className':"col-xs-12"}),((cljs.core.map_QMARK_(attrs59658))?[predict_prostate.components.bs3_navbar.hamburger_navbar(ttt)]:[daiquiri.interpreter.interpret(attrs59658),predict_prostate.components.bs3_navbar.hamburger_navbar(ttt)]));
})()]);
