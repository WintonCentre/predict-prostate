 ...
 */
predict_prostate.models.tests.clj_stata = (function predict_prostate$models$tests$clj_stata(p__34996){
var map__34997 = p__34996;
var map__34997__$1 = cljs.core.__destructure_map(map__34997);
var stata_in = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34997__$1,new cljs.core.Keyword(null,"stata-in","stata-in",-1119740949));
var stata_out = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34997__$1,new cljs.core.Keyword(null,"stata-out","stata-out",-287158852));
var clj_res = cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(predict_prostate.models.prostate_release.run_prostate(stata_in),new cljs.core.Keyword(null,"PCSsurvival","PCSsurvival",1208128423),(function (p1__34992_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__34992_SHARP_,(0));
})),new cljs.core.Keyword(null,"pred-PC-cum","pred-PC-cum",1965177836),(function (p1__34993_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__34993_SHARP_,(1));
})),new cljs.core.Keyword(null,"pred-NPC-cum","pred-NPC-cum",-1636287417),(function (p1__34994_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__34994_SHARP_,(1));
})),new cljs.core.Keyword(null,"NPC-survival","NPC-survival",-1399930619),(function (p1__34995_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__34995_SHARP_,(1));
}));
...
var failing_cases = cljs.core.filterv((function (p1__35000_SHARP_){
return cljs.core.some((function (x){
return (x > 1.0E-6);
}),cljs.core.vals(predict_prostate.models.tests.clj_stata(p1__35000_SHARP_)));
}),c);
...
predict_prostate.models.tests.file_error = (function predict_prostate$models$tests$file_error(p__35013){
var map__35014 = p__35013;
var map__35014__$1 = cljs.core.__destructure_map(map__35014);
var status = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35014__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
var status_text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35014__$1,new cljs.core.Keyword(null,"status-text","status-text",-1834235478));
 ...
 */
predict_prostate.models.tests.get_test_cases = (function predict_prostate$models$tests$get_test_cases(url,p__35015){
