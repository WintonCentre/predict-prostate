...
return daiquiri.core.create_element("ul",{'role':"tablist",'style':{'fontSize':"16px"},'className':"nav nav-pills"},[daiquiri.interpreter.interpret(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35090_SHARP_){
return rum.core.with_key(predict_prostate.layout.result_panel.result_tab_button(ttt,p1__35090_SHARP_),cljs.core.name(p1__35090_SHARP_));
...
return predict_prostate.results.charts.results_in_charts(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"title","title",636505583),(function (){var G__35094 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("chart","title","chart/title",739030541),"Overall Survival"], null);
return (ttt.cljs$core$IFn$_invoke$arity$1 ? ttt.cljs$core$IFn$_invoke$arity$1(G__35094) : ttt.call(null,G__35094));
...
return daiquiri.core.create_element("div",{'id':"results"},[daiquiri.core.create_element("h3",{'style':{'marginTop':(20)}},[daiquiri.interpreter.interpret((function (){var G__35096 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("results","title","results/title",-565898779),"Results"], null);
return (ttt.cljs$core$IFn$_invoke$arity$1 ? ttt.cljs$core$IFn$_invoke$arity$1(G__35096) : ttt.call(null,G__35096));
...
return daiquiri.core.create_element("div",{'style':{'marginTop':(20),'backgroundColor':predict_prostate.results.util.alison_blue_1},'className':"well"},[daiquiri.interpreter.interpret(predict_prostate.content_reader.all_subsections(ttt,"tool-postamble")),(cljs.core.truth_((function (){var G__35098 = cljs.core.deref(predict_prostate.state.run_time.input_cursor(new cljs.core.Keyword(null,"grade-group","grade-group",-1255212518)));
var fexpr__35097 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [(4),null,(5),null], null), null);
return (fexpr__35097.cljs$core$IFn$_invoke$arity$1 ? fexpr__35097.cljs$core$IFn$_invoke$arity$1(G__35098) : fexpr__35097.call(null,G__35098));
...
predict_prostate.layout.result_panel.results = rum.core.lazy_build(rum.core.build_defc,(function (p__35099){
var map__35100 = p__35099;
var map__35100__$1 = cljs.core.__destructure_map(map__35100);
var props = map__35100__$1;
var ttt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35100__$1,new cljs.core.Keyword(null,"ttt","ttt",1858561240));
var container_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35100__$1,new cljs.core.Keyword(null,"container?","container?",-1563620041));
