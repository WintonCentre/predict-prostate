...
var G__43435__delegate = function (p__43308,extra){
var map__43309 = p__43308;
var map__43309__$1 = cljs.core.__destructure_map(map__43309);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43309__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43309__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43309__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43309__$1,new cljs.core.Keyword(null,"params","params",710516235));
...
var G__43435 = function (p__43308,var_args){
var extra = null;
if (arguments.length > 1) {
var G__43437__i = 0, G__43437__a = new Array(arguments.length -  1);
while (G__43437__i < G__43437__a.length) {G__43437__a[G__43437__i] = arguments[G__43437__i + 1]; ++G__43437__i;}
  extra = new cljs.core.IndexedSeq(G__43437__a,0,null);
} 
return G__43435__delegate.call(this,p__43308,extra);};
G__43435.cljs$lang$maxFixedArity = 1;
G__43435.cljs$lang$applyTo = (function (arglist__43438){
var p__43308 = cljs.core.first(arglist__43438);
var extra = cljs.core.rest(arglist__43438);
return G__43435__delegate(p__43308,extra);
});
...
var hierarchy__4705__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__43320 = cljs.core.get_global_hierarchy;
return (fexpr__43320.cljs$core$IFn$_invoke$arity$0 ? fexpr__43320.cljs$core$IFn$_invoke$arity$0() : fexpr__43320.call(null));
})());
...
predict_prostate.state.load_config.make_widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"string","string",-1989541586),(function (p__43327){
var map__43328 = p__43327;
var map__43328__$1 = cljs.core.__destructure_map(map__43328);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43328__$1,new cljs.core.Keyword(null,"params","params",710516235));
...
predict_prostate.state.load_config.make_widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"information","information",12262679),(function (p__43371){
var map__43372 = p__43371;
var map__43372__$1 = cljs.core.__destructure_map(map__43372);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43372__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43372__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43372__$1,new cljs.core.Keyword(null,"params","params",710516235));
var unknowable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43372__$1,new cljs.core.Keyword(null,"unknowable","unknowable",1635948924));
var ttt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43372__$1,new cljs.core.Keyword(null,"ttt","ttt",1858561240));
...
predict_prostate.state.load_config.make_widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"radio-group","radio-group",1791520002),(function (p__43383){
var map__43384 = p__43383;
var map__43384__$1 = cljs.core.__destructure_map(map__43384);
var ttt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43384__$1,new cljs.core.Keyword(null,"ttt","ttt",1858561240));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43384__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43384__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43384__$1,new cljs.core.Keyword(null,"params","params",710516235));
var unknowable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43384__$1,new cljs.core.Keyword(null,"unknowable","unknowable",1635948924));
...
predict_prostate.state.load_config.make_widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"radio-group-vertical","radio-group-vertical",30488436),(function (p__43391){
var map__43392 = p__43391;
var map__43392__$1 = cljs.core.__destructure_map(map__43392);
var ttt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43392__$1,new cljs.core.Keyword(null,"ttt","ttt",1858561240));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43392__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43392__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43392__$1,new cljs.core.Keyword(null,"params","params",710516235));
var unknowable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43392__$1,new cljs.core.Keyword(null,"unknowable","unknowable",1635948924));
...
predict_prostate.state.load_config.make_widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"numeric-input","numeric-input",1592356787),(function (p__43397){
var map__43398 = p__43397;
var map__43398__$1 = cljs.core.__destructure_map(map__43398);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43398__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43398__$1,new cljs.core.Keyword(null,"params","params",710516235));
return wc_rum_lib.numeric_input.numeric_input(cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(params,new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.name(key),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"input-ref","input-ref",575432746),predict_prostate.state.run_time.input_cursor(key),new cljs.core.Keyword(null,"onChange","onChange",-312891301),(function (p1__43395_SHARP_){
return pubsub.feeds.publish(predict_prostate.state.run_time.input_change(key),p1__43395_SHARP_);
})], 0)));
}));
predict_prostate.state.load_config.make_widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"select","select",1147833503),(function (p__43404){
var map__43405 = p__43404;
var map__43405__$1 = cljs.core.__destructure_map(map__43405);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43405__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43405__$1,new cljs.core.Keyword(null,"params","params",710516235));
return predict_prostate.components.select.picker(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),key,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__43402_SHARP_){
return pubsub.feeds.publish(predict_prostate.state.run_time.input_change(key),p1__43402_SHARP_);
...
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43413__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43413__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var widget_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43413__$1,new cljs.core.Keyword(null,"widget-type","widget-type",1836256899));
var widget_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43413__$1,new cljs.core.Keyword(null,"widget-params","widget-params",1462627490));
var unknowable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43413__$1,new cljs.core.Keyword(null,"unknowable","unknowable",1635948924));
...
var map__43421 = options;
var map__43421__$1 = cljs.core.__destructure_map(map__43421);
var widget_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43421__$1,new cljs.core.Keyword(null,"widget-type","widget-type",1836256899));
var widget_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43421__$1,new cljs.core.Keyword(null,"widget-params","widget-params",1462627490));
...
var read_only = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43430__$1,new cljs.core.Keyword(null,"read-only","read-only",-191706886));
var write_only = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43430__$1,new cljs.core.Keyword(null,"write-only","write-only",292146609));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(predict_prostate.state.run_time.rtdb,cljs.core.update,new cljs.core.Keyword(null,"input-config","input-config",-1105526956),(function (p1__43431_SHARP_){
return predict_prostate.state.load_config.build_input_widgets_in(p1__43431_SHARP_,predict_prostate.state.config.input_groups);
}));
/**
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__43432_SHARP_){
var fexpr__43433 = new cljs.core.Keyword(null,"models","models",-1985455662).cljs$core$IFn$_invoke$arity$1(p1__43432_SHARP_);
return (fexpr__43433.cljs$core$IFn$_invoke$arity$1 ? fexpr__43433.cljs$core$IFn$_invoke$arity$1(model) : fexpr__43433.call(null,model));
}),predict_prostate.state.config.input_groups)));
});
