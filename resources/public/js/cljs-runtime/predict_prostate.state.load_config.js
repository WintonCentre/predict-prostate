...
var G__46207__delegate = function (p__46179,extra){
var map__46180 = p__46179;
var map__46180__$1 = cljs.core.__destructure_map(map__46180);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46180__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46180__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46180__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46180__$1,new cljs.core.Keyword(null,"params","params",710516235));
...
var G__46207 = function (p__46179,var_args){
var extra = null;
if (arguments.length > 1) {
var G__46208__i = 0, G__46208__a = new Array(arguments.length -  1);
while (G__46208__i < G__46208__a.length) {G__46208__a[G__46208__i] = arguments[G__46208__i + 1]; ++G__46208__i;}
  extra = new cljs.core.IndexedSeq(G__46208__a,0,null);
} 
return G__46207__delegate.call(this,p__46179,extra);};
G__46207.cljs$lang$maxFixedArity = 1;
G__46207.cljs$lang$applyTo = (function (arglist__46209){
var p__46179 = cljs.core.first(arglist__46209);
var extra = cljs.core.rest(arglist__46209);
return G__46207__delegate(p__46179,extra);
});
...
var hierarchy__4705__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__46181 = cljs.core.get_global_hierarchy;
return (fexpr__46181.cljs$core$IFn$_invoke$arity$0 ? fexpr__46181.cljs$core$IFn$_invoke$arity$0() : fexpr__46181.call(null));
})());
...
predict_prostate.state.load_config.make_widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"string","string",-1989541586),(function (p__46182){
var map__46183 = p__46182;
var map__46183__$1 = cljs.core.__destructure_map(map__46183);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46183__$1,new cljs.core.Keyword(null,"params","params",710516235));
...
predict_prostate.state.load_config.make_widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"information","information",12262679),(function (p__46184){
...
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46185__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46185__$1,new cljs.core.Keyword(null,"params","params",710516235));
...
var ttt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46185__$1,new cljs.core.Keyword(null,"ttt","ttt",1858561240));
...
predict_prostate.state.load_config.make_widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"radio-group","radio-group",1791520002),(function (p__46186){
var map__46187 = p__46186;
var map__46187__$1 = cljs.core.__destructure_map(map__46187);
var ttt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46187__$1,new cljs.core.Keyword(null,"ttt","ttt",1858561240));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46187__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46187__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46187__$1,new cljs.core.Keyword(null,"params","params",710516235));
var unknowable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46187__$1,new cljs.core.Keyword(null,"unknowable","unknowable",1635948924));
...
predict_prostate.state.load_config.make_widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"radio-group-vertical","radio-group-vertical",30488436),(function (p__46188){
var map__46189 = p__46188;
var map__46189__$1 = cljs.core.__destructure_map(map__46189);
var ttt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46189__$1,new cljs.core.Keyword(null,"ttt","ttt",1858561240));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46189__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46189__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46189__$1,new cljs.core.Keyword(null,"params","params",710516235));
var unknowable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46189__$1,new cljs.core.Keyword(null,"unknowable","unknowable",1635948924));
...
predict_prostate.state.load_config.make_widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"numeric-input","numeric-input",1592356787),(function (p__46191){
var map__46192 = p__46191;
var map__46192__$1 = cljs.core.__destructure_map(map__46192);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46192__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46192__$1,new cljs.core.Keyword(null,"params","params",710516235));
return wc_rum_lib.numeric_input.numeric_input(cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(params,new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.name(key),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"input-ref","input-ref",575432746),predict_prostate.state.run_time.input_cursor(key),new cljs.core.Keyword(null,"onChange","onChange",-312891301),(function (p1__46190_SHARP_){
return pubsub.feeds.publish(predict_prostate.state.run_time.input_change(key),p1__46190_SHARP_);
})], 0)));
}));
predict_prostate.state.load_config.make_widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"select","select",1147833503),(function (p__46196){
var map__46197 = p__46196;
var map__46197__$1 = cljs.core.__destructure_map(map__46197);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46197__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46197__$1,new cljs.core.Keyword(null,"params","params",710516235));
return predict_prostate.components.select.picker(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),key,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__46195_SHARP_){
return pubsub.feeds.publish(predict_prostate.state.run_time.input_change(key),p1__46195_SHARP_);
...
var map__46198 = g;
var map__46198__$1 = cljs.core.__destructure_map(map__46198);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46198__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46198__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var widget_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46198__$1,new cljs.core.Keyword(null,"widget-type","widget-type",1836256899));
var widget_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46198__$1,new cljs.core.Keyword(null,"widget-params","widget-params",1462627490));
var unknowable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46198__$1,new cljs.core.Keyword(null,"unknowable","unknowable",1635948924));
...
var map__46202 = options;
var map__46202__$1 = cljs.core.__destructure_map(map__46202);
var widget_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46202__$1,new cljs.core.Keyword(null,"widget-type","widget-type",1836256899));
var widget_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46202__$1,new cljs.core.Keyword(null,"widget-params","widget-params",1462627490));
...
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46203__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var read_only = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46203__$1,new cljs.core.Keyword(null,"read-only","read-only",-191706886));
var write_only = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46203__$1,new cljs.core.Keyword(null,"write-only","write-only",292146609));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(predict_prostate.state.run_time.rtdb,cljs.core.update,new cljs.core.Keyword(null,"input-config","input-config",-1105526956),(function (p1__46204_SHARP_){
return predict_prostate.state.load_config.build_input_widgets_in(p1__46204_SHARP_,predict_prostate.state.config.input_groups);
}));
/**
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46205_SHARP_){
var fexpr__46206 = new cljs.core.Keyword(null,"models","models",-1985455662).cljs$core$IFn$_invoke$arity$1(p1__46205_SHARP_);
return (fexpr__46206.cljs$core$IFn$_invoke$arity$1 ? fexpr__46206.cljs$core$IFn$_invoke$arity$1(model) : fexpr__46206.call(null,model));
}),predict_prostate.state.config.input_groups)));
});
