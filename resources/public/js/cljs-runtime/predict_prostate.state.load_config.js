...
var G__34675__delegate = function (p__34639,extra){
var map__34640 = p__34639;
var map__34640__$1 = cljs.core.__destructure_map(map__34640);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34640__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34640__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34640__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34640__$1,new cljs.core.Keyword(null,"params","params",710516235));
...
var G__34675 = function (p__34639,var_args){
var extra = null;
if (arguments.length > 1) {
var G__34676__i = 0, G__34676__a = new Array(arguments.length -  1);
while (G__34676__i < G__34676__a.length) {G__34676__a[G__34676__i] = arguments[G__34676__i + 1]; ++G__34676__i;}
  extra = new cljs.core.IndexedSeq(G__34676__a,0,null);
} 
return G__34675__delegate.call(this,p__34639,extra);};
G__34675.cljs$lang$maxFixedArity = 1;
G__34675.cljs$lang$applyTo = (function (arglist__34677){
var p__34639 = cljs.core.first(arglist__34677);
var extra = cljs.core.rest(arglist__34677);
return G__34675__delegate(p__34639,extra);
});
...
var hierarchy__4705__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__34641 = cljs.core.get_global_hierarchy;
return (fexpr__34641.cljs$core$IFn$_invoke$arity$0 ? fexpr__34641.cljs$core$IFn$_invoke$arity$0() : fexpr__34641.call(null));
})());
...
predict_prostate.state.load_config.make_widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"string","string",-1989541586),(function (p__34644){
var map__34645 = p__34644;
var map__34645__$1 = cljs.core.__destructure_map(map__34645);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34645__$1,new cljs.core.Keyword(null,"params","params",710516235));
...
predict_prostate.state.load_config.make_widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"information","information",12262679),(function (p__34648){
var map__34649 = p__34648;
var map__34649__$1 = cljs.core.__destructure_map(map__34649);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34649__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34649__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34649__$1,new cljs.core.Keyword(null,"params","params",710516235));
var unknowable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34649__$1,new cljs.core.Keyword(null,"unknowable","unknowable",1635948924));
var ttt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34649__$1,new cljs.core.Keyword(null,"ttt","ttt",1858561240));
...
predict_prostate.state.load_config.make_widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"radio-group","radio-group",1791520002),(function (p__34650){
var map__34651 = p__34650;
var map__34651__$1 = cljs.core.__destructure_map(map__34651);
var ttt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34651__$1,new cljs.core.Keyword(null,"ttt","ttt",1858561240));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34651__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34651__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34651__$1,new cljs.core.Keyword(null,"params","params",710516235));
var unknowable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34651__$1,new cljs.core.Keyword(null,"unknowable","unknowable",1635948924));
...
predict_prostate.state.load_config.make_widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"radio-group-vertical","radio-group-vertical",30488436),(function (p__34652){
var map__34656 = p__34652;
var map__34656__$1 = cljs.core.__destructure_map(map__34656);
var ttt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34656__$1,new cljs.core.Keyword(null,"ttt","ttt",1858561240));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34656__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34656__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34656__$1,new cljs.core.Keyword(null,"params","params",710516235));
var unknowable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34656__$1,new cljs.core.Keyword(null,"unknowable","unknowable",1635948924));
...
predict_prostate.state.load_config.make_widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"numeric-input","numeric-input",1592356787),(function (p__34658){
var map__34659 = p__34658;
var map__34659__$1 = cljs.core.__destructure_map(map__34659);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34659__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34659__$1,new cljs.core.Keyword(null,"params","params",710516235));
return wc_rum_lib.numeric_input.numeric_input(cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(params,new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.name(key),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"input-ref","input-ref",575432746),predict_prostate.state.run_time.input_cursor(key),new cljs.core.Keyword(null,"onChange","onChange",-312891301),(function (p1__34657_SHARP_){
return pubsub.feeds.publish(predict_prostate.state.run_time.input_change(key),p1__34657_SHARP_);
})], 0)));
}));
predict_prostate.state.load_config.make_widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"select","select",1147833503),(function (p__34662){
var map__34663 = p__34662;
var map__34663__$1 = cljs.core.__destructure_map(map__34663);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34663__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34663__$1,new cljs.core.Keyword(null,"params","params",710516235));
return predict_prostate.components.select.picker(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),key,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__34661_SHARP_){
return pubsub.feeds.publish(predict_prostate.state.run_time.input_change(key),p1__34661_SHARP_);
...
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34667__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34667__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var widget_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34667__$1,new cljs.core.Keyword(null,"widget-type","widget-type",1836256899));
var widget_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34667__$1,new cljs.core.Keyword(null,"widget-params","widget-params",1462627490));
var unknowable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34667__$1,new cljs.core.Keyword(null,"unknowable","unknowable",1635948924));
...
var map__34668 = options;
var map__34668__$1 = cljs.core.__destructure_map(map__34668);
var widget_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34668__$1,new cljs.core.Keyword(null,"widget-type","widget-type",1836256899));
var widget_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34668__$1,new cljs.core.Keyword(null,"widget-params","widget-params",1462627490));
...
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34669__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var read_only = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34669__$1,new cljs.core.Keyword(null,"read-only","read-only",-191706886));
var write_only = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34669__$1,new cljs.core.Keyword(null,"write-only","write-only",292146609));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(predict_prostate.state.run_time.rtdb,cljs.core.update,new cljs.core.Keyword(null,"input-config","input-config",-1105526956),(function (p1__34671_SHARP_){
return predict_prostate.state.load_config.build_input_widgets_in(p1__34671_SHARP_,predict_prostate.state.config.input_groups);
}));
/**
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__34672_SHARP_){
var fexpr__34673 = new cljs.core.Keyword(null,"models","models",-1985455662).cljs$core$IFn$_invoke$arity$1(p1__34672_SHARP_);
return (fexpr__34673.cljs$core$IFn$_invoke$arity$1 ? fexpr__34673.cljs$core$IFn$_invoke$arity$1(model) : fexpr__34673.call(null,model));
}),predict_prostate.state.config.input_groups)));
});
