...
var G__55776__delegate = function (p__55669,extra){
var map__55670 = p__55669;
var map__55670__$1 = cljs.core.__destructure_map(map__55670);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55670__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55670__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55670__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55670__$1,new cljs.core.Keyword(null,"params","params",710516235));
...
var G__55776 = function (p__55669,var_args){
var extra = null;
if (arguments.length > 1) {
var G__55781__i = 0, G__55781__a = new Array(arguments.length -  1);
while (G__55781__i < G__55781__a.length) {G__55781__a[G__55781__i] = arguments[G__55781__i + 1]; ++G__55781__i;}
  extra = new cljs.core.IndexedSeq(G__55781__a,0,null);
} 
return G__55776__delegate.call(this,p__55669,extra);};
G__55776.cljs$lang$maxFixedArity = 1;
G__55776.cljs$lang$applyTo = (function (arglist__55783){
var p__55669 = cljs.core.first(arglist__55783);
var extra = cljs.core.rest(arglist__55783);
return G__55776__delegate(p__55669,extra);
});
G__55776.cljs$core$IFn$_invoke$arity$variadic = G__55776__delegate;
return G__55776;
})()
...
var hierarchy__4705__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__55675 = cljs.core.get_global_hierarchy;
return (fexpr__55675.cljs$core$IFn$_invoke$arity$0 ? fexpr__55675.cljs$core$IFn$_invoke$arity$0() : fexpr__55675.call(null));
})());
...
predict_prostate.state.load_config.make_widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"string","string",-1989541586),(function (p__55678){
var map__55679 = p__55678;
var map__55679__$1 = cljs.core.__destructure_map(map__55679);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55679__$1,new cljs.core.Keyword(null,"params","params",710516235));
...
predict_prostate.state.load_config.make_widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"information","information",12262679),(function (p__55682){
var map__55683 = p__55682;
var map__55683__$1 = cljs.core.__destructure_map(map__55683);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55683__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55683__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55683__$1,new cljs.core.Keyword(null,"params","params",710516235));
var unknowable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55683__$1,new cljs.core.Keyword(null,"unknowable","unknowable",1635948924));
var ttt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55683__$1,new cljs.core.Keyword(null,"ttt","ttt",1858561240));
...
predict_prostate.state.load_config.make_widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"radio-group","radio-group",1791520002),(function (p__55685){
var map__55686 = p__55685;
var map__55686__$1 = cljs.core.__destructure_map(map__55686);
var ttt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55686__$1,new cljs.core.Keyword(null,"ttt","ttt",1858561240));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55686__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55686__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55686__$1,new cljs.core.Keyword(null,"params","params",710516235));
var unknowable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55686__$1,new cljs.core.Keyword(null,"unknowable","unknowable",1635948924));
...
predict_prostate.state.load_config.make_widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"radio-group-vertical","radio-group-vertical",30488436),(function (p__55688){
var map__55689 = p__55688;
var map__55689__$1 = cljs.core.__destructure_map(map__55689);
var ttt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55689__$1,new cljs.core.Keyword(null,"ttt","ttt",1858561240));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55689__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55689__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55689__$1,new cljs.core.Keyword(null,"params","params",710516235));
var unknowable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55689__$1,new cljs.core.Keyword(null,"unknowable","unknowable",1635948924));
...
predict_prostate.state.load_config.make_widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"numeric-input","numeric-input",1592356787),(function (p__55692){
var map__55693 = p__55692;
var map__55693__$1 = cljs.core.__destructure_map(map__55693);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55693__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55693__$1,new cljs.core.Keyword(null,"params","params",710516235));
return wc_rum_lib.numeric_input.numeric_input(cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(params,new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.name(key),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"input-ref","input-ref",575432746),predict_prostate.state.run_time.input_cursor(key),new cljs.core.Keyword(null,"onChange","onChange",-312891301),(function (p1__55691_SHARP_){
return pubsub.feeds.publish(predict_prostate.state.run_time.input_change(key),p1__55691_SHARP_);
})], 0)));
}));
predict_prostate.state.load_config.make_widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"select","select",1147833503),(function (p__55701){
var map__55702 = p__55701;
var map__55702__$1 = cljs.core.__destructure_map(map__55702);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55702__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55702__$1,new cljs.core.Keyword(null,"params","params",710516235));
return predict_prostate.components.select.picker(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),key,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__55699_SHARP_){
return pubsub.feeds.publish(predict_prostate.state.run_time.input_change(key),p1__55699_SHARP_);
...
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55713__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55713__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var widget_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55713__$1,new cljs.core.Keyword(null,"widget-type","widget-type",1836256899));
var widget_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55713__$1,new cljs.core.Keyword(null,"widget-params","widget-params",1462627490));
var unknowable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55713__$1,new cljs.core.Keyword(null,"unknowable","unknowable",1635948924));
...
var map__55728 = options;
var map__55728__$1 = cljs.core.__destructure_map(map__55728);
var widget_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55728__$1,new cljs.core.Keyword(null,"widget-type","widget-type",1836256899));
var widget_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55728__$1,new cljs.core.Keyword(null,"widget-params","widget-params",1462627490));
...
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55740__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var read_only = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55740__$1,new cljs.core.Keyword(null,"read-only","read-only",-191706886));
var write_only = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55740__$1,new cljs.core.Keyword(null,"write-only","write-only",292146609));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(predict_prostate.state.run_time.rtdb,cljs.core.update,new cljs.core.Keyword(null,"input-config","input-config",-1105526956),(function (p1__55754_SHARP_){
return predict_prostate.state.load_config.build_input_widgets_in(p1__55754_SHARP_,predict_prostate.state.config.input_groups);
}));
/**
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__55757_SHARP_){
var fexpr__55762 = new cljs.core.Keyword(null,"models","models",-1985455662).cljs$core$IFn$_invoke$arity$1(p1__55757_SHARP_);
return (fexpr__55762.cljs$core$IFn$_invoke$arity$1 ? fexpr__55762.cljs$core$IFn$_invoke$arity$1(model) : fexpr__55762.call(null,model));
}),predict_prostate.state.config.input_groups)));
});
