...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq31199){
var G__31200 = cljs.core.first(seq31199);
var seq31199__$1 = cljs.core.next(seq31199);
var G__31201 = cljs.core.first(seq31199__$1);
var seq31199__$2 = cljs.core.next(seq31199__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31200,G__31201,seq31199__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__31268_SHARP_){
return (!((cljs.core.meta(p1__31268_SHARP_) == null)));
})))){
...
var map__31281 = opts;
var map__31281__$1 = (((((!((map__31281 == null))))?(((((map__31281.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__31281.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__31281):map__31281);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31281__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e31288){var _e__30231__auto__ = e31288;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e31290){var _e__30231__auto__ = e31290;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__31292 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__31293 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__31293);

try{var map__31297 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31297__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__31292);
}});
...
var temp__5733__auto___31337 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___31337)){
var managed_print_level_31338 = temp__5733__auto___31337;
var _STAR_print_level_STAR__orig_val__31300_31339 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__31301_31340 = managed_print_level_31338;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__31301_31340);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__31299_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__31299_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__31300_31339);
}} else {
job_fn();
}
