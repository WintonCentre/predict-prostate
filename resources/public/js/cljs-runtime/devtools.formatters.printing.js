...
var len__4818__auto___31226 = arguments.length;
var i__4819__auto___31227 = (0);
while(true){
if((i__4819__auto___31227 < len__4818__auto___31226)){
args__4824__auto__.push((arguments[i__4819__auto___31227]));

var G__31228 = (i__4819__auto___31227 + (1));
i__4819__auto___31227 = G__31228;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq31136){
var G__31137 = cljs.core.first(seq31136);
var seq31136__$1 = cljs.core.next(seq31136);
var G__31138 = cljs.core.first(seq31136__$1);
var seq31136__$2 = cljs.core.next(seq31136__$1);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31137,G__31138,seq31136__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__31169_SHARP_){
return (!((cljs.core.meta(p1__31169_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31170__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e31171){var _e__30318__auto__ = e31171;
return false;
}})();
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
...
}catch (e31175){var _e__30318__auto__ = e31175;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__31181 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__31182 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__31182);

try{var map__31183 = opts;
var map__31183__$1 = cljs.core.__destructure_map(map__31183);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31183__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__31181);
}});
...
var temp__5751__auto___31232 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___31232)){
var managed_print_level_31234 = temp__5751__auto___31232;
var _STAR_print_level_STAR__orig_val__31224_31235 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__31225_31236 = managed_print_level_31234;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__31225_31236);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__31223_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__31223_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__31224_31235);
}} else {
job_fn();
}
