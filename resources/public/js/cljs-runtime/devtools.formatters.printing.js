...
var len__4736__auto___31328 = arguments.length;
var i__4737__auto___31329 = (0);
while(true){
if((i__4737__auto___31329 < len__4736__auto___31328)){
args__4742__auto__.push((arguments[i__4737__auto___31329]));

var G__31330 = (i__4737__auto___31329 + (1));
i__4737__auto___31329 = G__31330;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq31253){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__31289_SHARP_){
return (!((cljs.core.meta(p1__31289_SHARP_) == null)));
})))){
...
var map__31298 = opts;
var map__31298__$1 = (((((!((map__31298 == null))))?(((((map__31298.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__31298.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__31298):map__31298);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31298__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e31302){var _e__30075__auto__ = e31302;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e31304){var _e__30075__auto__ = e31304;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__31311 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__31312 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__31312);

try{var map__31313 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31313__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__31311);
}});
...
var temp__5733__auto___31361 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___31361)){
var managed_print_level_31362 = temp__5733__auto___31361;
var _STAR_print_level_STAR__orig_val__31321_31363 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__31322_31364 = managed_print_level_31362;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__31322_31364);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__31316_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__31316_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__31321_31363);
}} else {
job_fn();
}
