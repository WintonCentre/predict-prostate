...
var len__4736__auto___31301 = arguments.length;
var i__4737__auto___31302 = (0);
while(true){
if((i__4737__auto___31302 < len__4736__auto___31301)){
args__4742__auto__.push((arguments[i__4737__auto___31302]));

var G__31303 = (i__4737__auto___31302 + (1));
i__4737__auto___31302 = G__31303;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq31170){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__31251_SHARP_){
return (!((cljs.core.meta(p1__31251_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31260__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e31265){var _e__29962__auto__ = e31265;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e31267){var _e__29962__auto__ = e31267;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__31274 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__31275 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__31275);

try{var map__31277 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31277__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__31274);
}});
...
var temp__5733__auto___31371 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___31371)){
var managed_print_level_31372 = temp__5733__auto___31371;
var _STAR_print_level_STAR__orig_val__31289_31373 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__31290_31374 = managed_print_level_31372;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__31290_31374);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__31282_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__31282_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__31289_31373);
}} else {
job_fn();
}
