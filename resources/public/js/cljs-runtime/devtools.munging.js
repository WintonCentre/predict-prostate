...
var o30668 = temp__5733__auto__;
var temp__5733__auto____$1 = (o30668["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o30669 = temp__5733__auto____$1;
return (o30669["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__29903__auto__ = f;
return (o__29903__auto__["toString"]).call(o__29903__auto__);
} else {
return "";
}
}catch (e30672){var _ = e30672;
return "";
}});
...
try{var o__29903__auto___31029 = t;
(o__29903__auto___31029["cljs$lang$ctorPrWriter"]).call(o__29903__auto___31029,t,writer);
}catch (e30724){var __31030 = e30724;
}
...
var char_code = (function (){var o__29903__auto__ = (new String(char$));
return (o__29903__auto__["charCodeAt"]).call(o__29903__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__29903__auto__ = String;
return (o__29903__auto__["fromCharCode"]).call(o__29903__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__30731 = num_code;
switch (G__30731) {
case (1):
return (185);
...
var o__29903__auto__ = String;
return (o__29903__auto__["fromCharCode"]).call(o__29903__auto__,superscript_code);
});
/**
...
}catch (e30744){var _e__29962__auto__ = e30744;
return false;
}})())){
...
var vec__30747 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30747,(0),null);
...
var i__4737__auto___31054 = (0);
while(true){
if((i__4737__auto___31054 < len__4736__auto___31052)){
args__4742__auto__.push((arguments[i__4737__auto___31054]));

var G__31056 = (i__4737__auto___31054 + (1));
i__4737__auto___31054 = G__31056;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__30772){
var vec__30773 = p__30772;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30773,(0),null);
...
var G__31057 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__31058 = cljs.core.butlast(remaining_tokens);
name_tokens = G__31057;
remaining_tokens = G__31058;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq30770){
var G__30771 = cljs.core.first(seq30770);
var seq30770__$1 = cljs.core.next(seq30770);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30771,seq30770__$1);
}));
...
var vec__30784 = cljs.core.split_with((function (p1__30783_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__30783_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30784,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30784,(1),null);
...
var vec__30794 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30794,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30794,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__31060 = cljs.core.rest(remaining_tokens);
var G__31061 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__31060;
...
var vec__30809 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30809,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30809,(1),null);
var vec__30812 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30812,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30812,(1),null);
var vec__30815 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30815,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30815,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30815,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30815,(3),null);
...
var vec__30826 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30826,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30826,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30826,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30826,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30826,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30826,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__30829 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30829,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30829,(1),null);
var vec__30832 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30832,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30832,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__30837 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__30837) : devtools.munging.parse_fn_info_deep.call(null,G__30837));
})()));
}
} else {
return fn_info;
...
var G__31076 = (arity + (1));
var G__31077 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__30862){
var vec__30863 = p__30862;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30863,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30863,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30889_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__30889_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30890_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__30890_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__30904){
var vec__30905 = p__30904;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30905,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq30901){
var G__30902 = cljs.core.first(seq30901);
var seq30901__$1 = cljs.core.next(seq30901);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30902,seq30901__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30934__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30934__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30934__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30934__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__30935 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30935,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30935,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30935,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30935,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30935,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30935,(5),null);
...
var o__29903__auto__ = f;
return (o__29903__auto__["getBasis"]).call(o__29903__auto__);
});
/**
...
}catch (e30954){var _e__29962__auto__ = e30954;
...
var G__31097 = (obj[cljs.core.first(path)]);
var G__31098 = cljs.core.rest(path);
obj = G__31097;
path = G__31098;
continue;
} else {
...
var _STAR_ = (function (accum,p__30997){
var vec__30998 = p__30997;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30998,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30998,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__31008){
var vec__31009 = p__31008;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31009,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31009,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31009,(2),null);
...
var post_process = (function (p__31013){
var vec__31014 = p__31013;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31014,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31014,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31012_SHARP_){
return (obj[cljs.core.first(p1__31012_SHARP_)]);
}),sorted_matches);
