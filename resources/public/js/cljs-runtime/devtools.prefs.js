...
var G__30641 = devtools.prefs.get_prefs();
return (key.cljs$core$IFn$_invoke$arity$1 ? key.cljs$core$IFn$_invoke$arity$1(G__30641) : key.call(null,G__30641));
});
...
var G__30656 = (i__4737__auto___30654 + (1));
i__4737__auto___30654 = G__30656;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.prefs.update_pref_BANG_.cljs$lang$applyTo = (function (seq30647){
var G__30648 = cljs.core.first(seq30647);
var seq30647__$1 = cljs.core.next(seq30647);
var G__30649 = cljs.core.first(seq30647__$1);
var seq30647__$2 = cljs.core.next(seq30647__$1);
