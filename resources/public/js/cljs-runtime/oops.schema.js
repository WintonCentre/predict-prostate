...
var G__48783 = cljs.core.first(element_str);
switch (G__48783) {
case "?":
arr.push((1));
...
var G__48824 = cljs.core.next(items);
items = G__48824;
continue;
} else {
return null;
...
var G__48825 = cljs.core.next(items);
items = G__48825;
continue;
} else {
return null;
...
while(true){
if(items){
if(cljs.core.truth_((function (){var G__48798 = cljs.core.first(items);
return (is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1 ? is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1(G__48798) : is_valid_QMARK_.call(null,G__48798));
})())){
var G__48832 = cljs.core.next(cljs.core.next(items));
items = G__48832;
continue;
} else {
return true;
...
switch (G__48810) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__48803_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__48803_SHARP_,(2));
})))){
...
break;
case (1):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__48805_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__48805_SHARP_,(1));
})))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__48810)].join('')));
