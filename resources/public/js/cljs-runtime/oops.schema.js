...
var G__48832 = cljs.core.first(element_str);
switch (G__48832) {
case "?":
arr.push((1));
...
var G__48852 = cljs.core.next(items);
items = G__48852;
continue;
} else {
return null;
...
var G__48853 = cljs.core.next(items);
items = G__48853;
continue;
} else {
return null;
...
while(true){
if(items){
if(cljs.core.truth_((function (){var G__48839 = cljs.core.first(items);
return (is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1 ? is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1(G__48839) : is_valid_QMARK_.call(null,G__48839));
})())){
var G__48856 = cljs.core.next(cljs.core.next(items));
items = G__48856;
continue;
} else {
return true;
...
switch (G__48845) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__48841_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__48841_SHARP_,(2));
})))){
...
break;
case (1):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__48842_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__48842_SHARP_,(1));
})))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__48845)].join('')));
