...
var default_50391 = predict_prostate.state.config.get_input_default(predict_prostate.state.config.input_groups,key);
pubsub.feeds.publish(predict_prostate.state.run_time.input_change(key),default_50391);
...
return React.createElement("div",null,cljs.core.into_array.cljs$core$IFn$_invoke$arity$1((function (){var iter__4529__auto__ = (function predict_prostate$results$icons$iter__50329(s__50330){
return (new cljs.core.LazySeq(null,(function (){
var s__50330__$1 = s__50330;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__50330__$1);
if(temp__5735__auto__){
var xs__6292__auto__ = temp__5735__auto__;
var y = cljs.core.first(xs__6292__auto__);
var iterys__4525__auto__ = ((function (s__50330__$1,y,xs__6292__auto__,temp__5735__auto__,cum_counts){
return (function predict_prostate$results$icons$iter__50329_$_iter__50331(s__50332){
return (new cljs.core.LazySeq(null,((function (s__50330__$1,y,xs__6292__auto__,temp__5735__auto__,cum_counts){
return (function (){
var s__50332__$1 = s__50332;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__50332__$1);
if(temp__5735__auto____$1){
var s__50332__$2 = temp__5735__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__50332__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__50332__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__50334 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__50333 = (0);
while(true){
if((i__50333 < size__4528__auto__)){
var x = cljs.core._nth(c__4527__auto__,i__50333);
var n = (x + ((10) * y));
...
cljs.core.chunk_append(b__50334,sablono.interpreter.interpret(rum.core.with_key((function (){var G__50343 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"fill","fill",883462889),new cljs.core.Keyword(null,"fill","fill",883462889).cljs$core$IFn$_invoke$arity$1(style),new cljs.core.Keyword(null,"x","x",2099068185),x,new cljs.core.Keyword(null,"y","y",-1757859776),y], null);
return (shape.cljs$core$IFn$_invoke$arity$1 ? shape.cljs$core$IFn$_invoke$arity$1(G__50343) : shape.call(null,G__50343));
})(),n)));

var G__50422 = (i__50333 + (1));
i__50333 = G__50422;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50334),predict_prostate$results$icons$iter__50329_$_iter__50331(cljs.core.chunk_rest(s__50332__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50334),null);
}
} else {
var x = cljs.core.first(s__50332__$2);
var n = (x + ((10) * y));
var style = predict_prostate.results.icons.color_picker(fill_counts,cum_counts,n);
var shape = (cljs.core.truth_(new cljs.core.Keyword(null,"filled","filled",1908725116).cljs$core$IFn$_invoke$arity$1(style))?predict_prostate.components.primitives.pic:predict_prostate.components.primitives.pic_dead);
return cljs.core.cons(sablono.interpreter.interpret(rum.core.with_key((function (){var G__50346 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"fill","fill",883462889),new cljs.core.Keyword(null,"fill","fill",883462889).cljs$core$IFn$_invoke$arity$1(style),new cljs.core.Keyword(null,"x","x",2099068185),x,new cljs.core.Keyword(null,"y","y",-1757859776),y], null);
return (shape.cljs$core$IFn$_invoke$arity$1 ? shape.cljs$core$IFn$_invoke$arity$1(G__50346) : shape.call(null,G__50346));
})(),n)),predict_prostate$results$icons$iter__50329_$_iter__50331(cljs.core.rest(s__50332__$2)));
}
} else {
return null;
}
...
});})(s__50330__$1,y,xs__6292__auto__,temp__5735__auto__,cum_counts))
,null,null));
});})(s__50330__$1,y,xs__6292__auto__,temp__5735__auto__,cum_counts))
;
var fs__4526__auto__ = cljs.core.seq(iterys__4525__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1((10))));
if(fs__4526__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__4526__auto__,predict_prostate$results$icons$iter__50329(cljs.core.rest(s__50330__$1)));
} else {
var G__50423 = cljs.core.rest(s__50330__$1);
s__50330__$1 = G__50423;
continue;
}
} else {
return null;
...
var one_sum = (function (p1__50348_SHARP_,p2__50349_SHARP_){
return ((100) * ((1) - (p1__50348_SHARP_ + p2__50349_SHARP_)));
});
...
predict_prostate.results.icons.results_in_icons_STAR_ = rum.core.build_defc((function (p__50357){
...
var printable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50358__$1,new cljs.core.Keyword(null,"printable","printable",-928999004));
var ttt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50358__$1,new cljs.core.Keyword(null,"ttt","ttt",1858561240));
...
var cs = (function (){var G__50361 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"conservative-survival","conservative-survival",-852356338).cljs$core$IFn$_invoke$arity$1(data),years);
return (predict_prostate.results.icons.round.cljs$core$IFn$_invoke$arity$1 ? predict_prostate.results.icons.round.cljs$core$IFn$_invoke$arity$1(G__50361) : predict_prostate.results.icons.round.call(null,G__50361));
})();
var rs = ((radical_QMARK_)?(function (){var G__50362 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"radical-survival","radical-survival",-74207469).cljs$core$IFn$_invoke$arity$1(data),years);
return (predict_prostate.results.icons.round.cljs$core$IFn$_invoke$arity$1 ? predict_prostate.results.icons.round.cljs$core$IFn$_invoke$arity$1(G__50362) : predict_prostate.results.icons.round.call(null,G__50362));
})():(0));
var benefit = ((radical_QMARK_)?(rs - cs):(0));
var pc_deaths = (function (){var G__50363 = ((cljs.core.nth.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"dotted-orange","dotted-orange",-573056274).cljs$core$IFn$_invoke$arity$1(data),years) - cs) - benefit);
return (predict_prostate.results.icons.round.cljs$core$IFn$_invoke$arity$1 ? predict_prostate.results.icons.round.cljs$core$IFn$_invoke$arity$1(G__50363) : predict_prostate.results.icons.round.call(null,G__50363));
})();
