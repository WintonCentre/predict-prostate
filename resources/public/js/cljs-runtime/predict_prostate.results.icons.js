...
var default_34075 = predict_prostate.state.config.get_input_default(predict_prostate.state.config.input_groups,key);
pubsub.feeds.publish(predict_prostate.state.run_time.input_change(key),default_34075);
...
return React.createElement("div",null,cljs.core.into_array.cljs$core$IFn$_invoke$arity$1((function (){var iter__4529__auto__ = (function predict_prostate$results$icons$iter__33966(s__33967){
return (new cljs.core.LazySeq(null,(function (){
var s__33967__$1 = s__33967;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__33967__$1);
if(temp__5735__auto__){
var xs__6292__auto__ = temp__5735__auto__;
var y = cljs.core.first(xs__6292__auto__);
var iterys__4525__auto__ = ((function (s__33967__$1,y,xs__6292__auto__,temp__5735__auto__,cum_counts){
return (function predict_prostate$results$icons$iter__33966_$_iter__33968(s__33969){
return (new cljs.core.LazySeq(null,((function (s__33967__$1,y,xs__6292__auto__,temp__5735__auto__,cum_counts){
return (function (){
var s__33969__$1 = s__33969;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__33969__$1);
if(temp__5735__auto____$1){
var s__33969__$2 = temp__5735__auto____$1;
...
var x = cljs.core._nth(c__4527__auto__,i__33970);
var n = (x + ((10) * y));
...
cljs.core.chunk_append(b__33971,sablono.interpreter.interpret(rum.core.with_key((function (){var G__33992 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"fill","fill",883462889),new cljs.core.Keyword(null,"fill","fill",883462889).cljs$core$IFn$_invoke$arity$1(style),new cljs.core.Keyword(null,"x","x",2099068185),x,new cljs.core.Keyword(null,"y","y",-1757859776),y], null);
return (shape.cljs$core$IFn$_invoke$arity$1 ? shape.cljs$core$IFn$_invoke$arity$1(G__33992) : shape.call(null,G__33992));
})(),n)));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__33971),predict_prostate$results$icons$iter__33966_$_iter__33968(cljs.core.chunk_rest(s__33969__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__33971),null);
}
} else {
var x = cljs.core.first(s__33969__$2);
var n = (x + ((10) * y));
var style = predict_prostate.results.icons.color_picker(fill_counts,cum_counts,n);
var shape = (cljs.core.truth_(new cljs.core.Keyword(null,"filled","filled",1908725116).cljs$core$IFn$_invoke$arity$1(style))?predict_prostate.components.primitives.pic:predict_prostate.components.primitives.pic_dead);
return cljs.core.cons(sablono.interpreter.interpret(rum.core.with_key((function (){var G__34010 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"fill","fill",883462889),new cljs.core.Keyword(null,"fill","fill",883462889).cljs$core$IFn$_invoke$arity$1(style),new cljs.core.Keyword(null,"x","x",2099068185),x,new cljs.core.Keyword(null,"y","y",-1757859776),y], null);
return (shape.cljs$core$IFn$_invoke$arity$1 ? shape.cljs$core$IFn$_invoke$arity$1(G__34010) : shape.call(null,G__34010));
})(),n)),predict_prostate$results$icons$iter__33966_$_iter__33968(cljs.core.rest(s__33969__$2)));
}
} else {
return null;
}
...
});})(s__33967__$1,y,xs__6292__auto__,temp__5735__auto__,cum_counts))
,null,null));
});})(s__33967__$1,y,xs__6292__auto__,temp__5735__auto__,cum_counts))
;
var fs__4526__auto__ = cljs.core.seq(iterys__4525__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1((10))));
if(fs__4526__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__4526__auto__,predict_prostate$results$icons$iter__33966(cljs.core.rest(s__33967__$1)));
} else {
var G__34150 = cljs.core.rest(s__33967__$1);
s__33967__$1 = G__34150;
continue;
}
} else {
return null;
...
var one_sum = (function (p1__34012_SHARP_,p2__34013_SHARP_){
return ((100) * ((1) - (p1__34012_SHARP_ + p2__34013_SHARP_)));
});
...
predict_prostate.results.icons.results_in_icons_STAR_ = rum.core.build_defc((function (p__34024){
...
var printable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34025__$1,new cljs.core.Keyword(null,"printable","printable",-928999004));
...
var cs = (function (){var G__34032 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"conservative-survival","conservative-survival",-852356338).cljs$core$IFn$_invoke$arity$1(data),years);
return (predict_prostate.results.icons.round.cljs$core$IFn$_invoke$arity$1 ? predict_prostate.results.icons.round.cljs$core$IFn$_invoke$arity$1(G__34032) : predict_prostate.results.icons.round.call(null,G__34032));
})();
var rs = ((radical_QMARK_)?(function (){var G__34035 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"radical-survival","radical-survival",-74207469).cljs$core$IFn$_invoke$arity$1(data),years);
return (predict_prostate.results.icons.round.cljs$core$IFn$_invoke$arity$1 ? predict_prostate.results.icons.round.cljs$core$IFn$_invoke$arity$1(G__34035) : predict_prostate.results.icons.round.call(null,G__34035));
})():(0));
var benefit = ((radical_QMARK_)?(rs - cs):(0));
var pc_deaths = (function (){var G__34037 = ((cljs.core.nth.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"dotted-orange","dotted-orange",-573056274).cljs$core$IFn$_invoke$arity$1(data),years) - cs) - benefit);
return (predict_prostate.results.icons.round.cljs$core$IFn$_invoke$arity$1 ? predict_prostate.results.icons.round.cljs$core$IFn$_invoke$arity$1(G__34037) : predict_prostate.results.icons.round.call(null,G__34037));
})();
...
return React.createElement("div",null,React.createElement("div",null,React.createElement("div",({"style": ({"position": "relative"}), "className": "row"}),React.createElement("div",({"style": ({"marginTop": "15px", "fontSize": (16)}), "className": "col-xs-12 screen-only"}),"This display shows the outcomes for 100 men. These results are based on the inputs and treatments you selected ",(function (){var attrs34062 = (predict_prostate.components.button.year_picker.cljs$core$IFn$_invoke$arity$0 ? predict_prostate.components.button.year_picker.cljs$core$IFn$_invoke$arity$0() : predict_prostate.components.button.year_picker.call(null));
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(React.createElement,"span",((cljs.core.map_QMARK_(attrs34062))?sablono.interpreter.attributes(sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["screen-only"], null)], null),attrs34062], 0))):({"className": "screen-only"})),((cljs.core.map_QMARK_(attrs34062))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret(attrs34062)], null)));
})(),React.createElement("span",({"style": ({"fontSize": (12)}), "className": "print-only"}),sablono.interpreter.interpret(years))," years after diagnosis"),(function (){var attrs34061 = render_year(years,data);
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(React.createElement,"div",((cljs.core.map_QMARK_(attrs34061))?sablono.interpreter.attributes(sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["col-xs-12"], null)], null),attrs34061], 0))):({"className": "col-xs-12"})),((cljs.core.map_QMARK_(attrs34061))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret(attrs34061)], null)));
