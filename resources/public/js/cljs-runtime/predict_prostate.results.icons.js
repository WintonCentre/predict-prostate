...
var default_47421 = predict_prostate.state.config.get_input_default(predict_prostate.state.config.input_groups,key);
pubsub.feeds.publish(predict_prostate.state.run_time.input_change(key),default_47421);
...
return React.createElement("div",null,cljs.core.into_array.cljs$core$IFn$_invoke$arity$1((function (){var iter__4529__auto__ = (function predict_prostate$results$icons$iter__47344(s__47345){
return (new cljs.core.LazySeq(null,(function (){
var s__47345__$1 = s__47345;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__47345__$1);
if(temp__5735__auto__){
var xs__6292__auto__ = temp__5735__auto__;
var y = cljs.core.first(xs__6292__auto__);
var iterys__4525__auto__ = ((function (s__47345__$1,y,xs__6292__auto__,temp__5735__auto__,cum_counts){
return (function predict_prostate$results$icons$iter__47344_$_iter__47347(s__47348){
return (new cljs.core.LazySeq(null,((function (s__47345__$1,y,xs__6292__auto__,temp__5735__auto__,cum_counts){
return (function (){
var s__47348__$1 = s__47348;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__47348__$1);
if(temp__5735__auto____$1){
var s__47348__$2 = temp__5735__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__47348__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__47348__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__47350 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__47349 = (0);
while(true){
if((i__47349 < size__4528__auto__)){
var x = cljs.core._nth(c__4527__auto__,i__47349);
var n = (x + ((10) * y));
...
cljs.core.chunk_append(b__47350,sablono.interpreter.interpret(rum.core.with_key((function (){var G__47367 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"fill","fill",883462889),new cljs.core.Keyword(null,"fill","fill",883462889).cljs$core$IFn$_invoke$arity$1(style),new cljs.core.Keyword(null,"x","x",2099068185),x,new cljs.core.Keyword(null,"y","y",-1757859776),y], null);
return (shape.cljs$core$IFn$_invoke$arity$1 ? shape.cljs$core$IFn$_invoke$arity$1(G__47367) : shape.call(null,G__47367));
})(),n)));

var G__47428 = (i__47349 + (1));
i__47349 = G__47428;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__47350),predict_prostate$results$icons$iter__47344_$_iter__47347(cljs.core.chunk_rest(s__47348__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__47350),null);
}
} else {
var x = cljs.core.first(s__47348__$2);
var n = (x + ((10) * y));
var style = predict_prostate.results.icons.color_picker(fill_counts,cum_counts,n);
var shape = (cljs.core.truth_(new cljs.core.Keyword(null,"filled","filled",1908725116).cljs$core$IFn$_invoke$arity$1(style))?predict_prostate.components.primitives.pic:predict_prostate.components.primitives.pic_dead);
return cljs.core.cons(sablono.interpreter.interpret(rum.core.with_key((function (){var G__47371 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"fill","fill",883462889),new cljs.core.Keyword(null,"fill","fill",883462889).cljs$core$IFn$_invoke$arity$1(style),new cljs.core.Keyword(null,"x","x",2099068185),x,new cljs.core.Keyword(null,"y","y",-1757859776),y], null);
return (shape.cljs$core$IFn$_invoke$arity$1 ? shape.cljs$core$IFn$_invoke$arity$1(G__47371) : shape.call(null,G__47371));
})(),n)),predict_prostate$results$icons$iter__47344_$_iter__47347(cljs.core.rest(s__47348__$2)));
}
} else {
return null;
}
...
});})(s__47345__$1,y,xs__6292__auto__,temp__5735__auto__,cum_counts))
,null,null));
});})(s__47345__$1,y,xs__6292__auto__,temp__5735__auto__,cum_counts))
;
var fs__4526__auto__ = cljs.core.seq(iterys__4525__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1((10))));
if(fs__4526__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__4526__auto__,predict_prostate$results$icons$iter__47344(cljs.core.rest(s__47345__$1)));
} else {
var G__47432 = cljs.core.rest(s__47345__$1);
s__47345__$1 = G__47432;
continue;
}
} else {
return null;
...
var one_sum = (function (p1__47376_SHARP_,p2__47377_SHARP_){
return ((100) * ((1) - (p1__47376_SHARP_ + p2__47377_SHARP_)));
});
...
predict_prostate.results.icons.results_in_icons_STAR_ = rum.core.build_defc((function (p__47386){
...
var printable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47387__$1,new cljs.core.Keyword(null,"printable","printable",-928999004));
...
var cs = (function (){var G__47394 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"conservative-survival","conservative-survival",-852356338).cljs$core$IFn$_invoke$arity$1(data),years);
return (predict_prostate.results.icons.round.cljs$core$IFn$_invoke$arity$1 ? predict_prostate.results.icons.round.cljs$core$IFn$_invoke$arity$1(G__47394) : predict_prostate.results.icons.round.call(null,G__47394));
})();
var rs = ((radical_QMARK_)?(function (){var G__47396 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"radical-survival","radical-survival",-74207469).cljs$core$IFn$_invoke$arity$1(data),years);
return (predict_prostate.results.icons.round.cljs$core$IFn$_invoke$arity$1 ? predict_prostate.results.icons.round.cljs$core$IFn$_invoke$arity$1(G__47396) : predict_prostate.results.icons.round.call(null,G__47396));
})():(0));
var benefit = ((radical_QMARK_)?(rs - cs):(0));
var pc_deaths = (function (){var G__47398 = ((cljs.core.nth.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"dotted-orange","dotted-orange",-573056274).cljs$core$IFn$_invoke$arity$1(data),years) - cs) - benefit);
return (predict_prostate.results.icons.round.cljs$core$IFn$_invoke$arity$1 ? predict_prostate.results.icons.round.cljs$core$IFn$_invoke$arity$1(G__47398) : predict_prostate.results.icons.round.call(null,G__47398));
})();
