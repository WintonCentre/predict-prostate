...
var default_129023 = predict_prostate.state.config.get_input_default(predict_prostate.state.config.input_groups,key);
pubsub.feeds.publish(predict_prostate.state.run_time.input_change(key),default_129023);
...
return React.createElement("div",null,cljs.core.into_array.cljs$core$IFn$_invoke$arity$1((function (){var iter__4529__auto__ = (function predict_prostate$results$icons$iter__128931(s__128932){
return (new cljs.core.LazySeq(null,(function (){
var s__128932__$1 = s__128932;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__128932__$1);
if(temp__5735__auto__){
var xs__6292__auto__ = temp__5735__auto__;
var y = cljs.core.first(xs__6292__auto__);
var iterys__4525__auto__ = ((function (s__128932__$1,y,xs__6292__auto__,temp__5735__auto__,cum_counts){
return (function predict_prostate$results$icons$iter__128931_$_iter__128939(s__128940){
return (new cljs.core.LazySeq(null,((function (s__128932__$1,y,xs__6292__auto__,temp__5735__auto__,cum_counts){
return (function (){
var s__128940__$1 = s__128940;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__128940__$1);
if(temp__5735__auto____$1){
var s__128940__$2 = temp__5735__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__128940__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__128940__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__128942 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__128941 = (0);
while(true){
if((i__128941 < size__4528__auto__)){
var x = cljs.core._nth(c__4527__auto__,i__128941);
var n = (x + ((10) * y));
...
cljs.core.chunk_append(b__128942,sablono.interpreter.interpret(rum.core.with_key((function (){var G__128971 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"fill","fill",883462889),new cljs.core.Keyword(null,"fill","fill",883462889).cljs$core$IFn$_invoke$arity$1(style),new cljs.core.Keyword(null,"x","x",2099068185),x,new cljs.core.Keyword(null,"y","y",-1757859776),y], null);
return (shape.cljs$core$IFn$_invoke$arity$1 ? shape.cljs$core$IFn$_invoke$arity$1(G__128971) : shape.call(null,G__128971));
})(),n)));

var G__129032 = (i__128941 + (1));
i__128941 = G__129032;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__128942),predict_prostate$results$icons$iter__128931_$_iter__128939(cljs.core.chunk_rest(s__128940__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__128942),null);
}
} else {
var x = cljs.core.first(s__128940__$2);
var n = (x + ((10) * y));
var style = predict_prostate.results.icons.color_picker(fill_counts,cum_counts,n);
var shape = (cljs.core.truth_(new cljs.core.Keyword(null,"filled","filled",1908725116).cljs$core$IFn$_invoke$arity$1(style))?predict_prostate.components.primitives.pic:predict_prostate.components.primitives.pic_dead);
return cljs.core.cons(sablono.interpreter.interpret(rum.core.with_key((function (){var G__128983 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"fill","fill",883462889),new cljs.core.Keyword(null,"fill","fill",883462889).cljs$core$IFn$_invoke$arity$1(style),new cljs.core.Keyword(null,"x","x",2099068185),x,new cljs.core.Keyword(null,"y","y",-1757859776),y], null);
return (shape.cljs$core$IFn$_invoke$arity$1 ? shape.cljs$core$IFn$_invoke$arity$1(G__128983) : shape.call(null,G__128983));
})(),n)),predict_prostate$results$icons$iter__128931_$_iter__128939(cljs.core.rest(s__128940__$2)));
}
} else {
return null;
}
...
});})(s__128932__$1,y,xs__6292__auto__,temp__5735__auto__,cum_counts))
,null,null));
});})(s__128932__$1,y,xs__6292__auto__,temp__5735__auto__,cum_counts))
;
var fs__4526__auto__ = cljs.core.seq(iterys__4525__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1((10))));
if(fs__4526__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__4526__auto__,predict_prostate$results$icons$iter__128931(cljs.core.rest(s__128932__$1)));
} else {
var G__129034 = cljs.core.rest(s__128932__$1);
s__128932__$1 = G__129034;
continue;
}
} else {
return null;
...
var one_sum = (function (p1__128989_SHARP_,p2__128990_SHARP_){
return ((100) * ((1) - (p1__128989_SHARP_ + p2__128990_SHARP_)));
});
...
predict_prostate.results.icons.results_in_icons_STAR_ = rum.core.build_defc((function (p__128994){
var map__128995 = p__128994;
var map__128995__$1 = (((((!((map__128995 == null))))?(((((map__128995.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__128995.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__128995):map__128995);
var printable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__128995__$1,new cljs.core.Keyword(null,"printable","printable",-928999004));
var ttt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__128995__$1,new cljs.core.Keyword(null,"ttt","ttt",1858561240));
...
var cs = (function (){var G__128998 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"conservative-survival","conservative-survival",-852356338).cljs$core$IFn$_invoke$arity$1(data),years);
return (predict_prostate.results.icons.round.cljs$core$IFn$_invoke$arity$1 ? predict_prostate.results.icons.round.cljs$core$IFn$_invoke$arity$1(G__128998) : predict_prostate.results.icons.round.call(null,G__128998));
})();
var rs = ((radical_QMARK_)?(function (){var G__128999 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"radical-survival","radical-survival",-74207469).cljs$core$IFn$_invoke$arity$1(data),years);
return (predict_prostate.results.icons.round.cljs$core$IFn$_invoke$arity$1 ? predict_prostate.results.icons.round.cljs$core$IFn$_invoke$arity$1(G__128999) : predict_prostate.results.icons.round.call(null,G__128999));
})():(0));
var benefit = ((radical_QMARK_)?(rs - cs):(0));
var pc_deaths = (function (){var G__129001 = ((cljs.core.nth.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"dotted-orange","dotted-orange",-573056274).cljs$core$IFn$_invoke$arity$1(data),years) - cs) - benefit);
return (predict_prostate.results.icons.round.cljs$core$IFn$_invoke$arity$1 ? predict_prostate.results.icons.round.cljs$core$IFn$_invoke$arity$1(G__129001) : predict_prostate.results.icons.round.call(null,G__129001));
})();
