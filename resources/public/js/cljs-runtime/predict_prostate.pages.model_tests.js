...
predict_prostate.models.tests.get_test_cases("/test-runs.txt",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"handler","handler",-195596612),(function (p1__61801_SHARP_){
return cljs.core.async.put_BANG_.cljs$core$IFn$_invoke$arity$2(predict_prostate.pages.model_tests.load_chan,p1__61801_SHARP_);
})], null));

var c__30019__auto__ = cljs.core.async.chan.cljs$core$IFn$_invoke$arity$1((1));
cljs.core.async.impl.dispatch.run((function (){
var f__30020__auto__ = (function (){var switch__29949__auto__ = (function (state_61806){
var state_val_61807 = (state_61806[(1)]);
if((state_val_61807 === (1))){
var inst_61803 = (function (){return (function (p1__61802_SHARP_){
return predict_prostate.models.tests.test_all_cases(cljs.reader.read_string.cljs$core$IFn$_invoke$arity$1(p1__61802_SHARP_));
});
})();
var inst_61804 = cljs.core.async.take_BANG_.cljs$core$IFn$_invoke$arity$2(predict_prostate.pages.model_tests.load_chan,inst_61803);
...
var statearr_61808 = [null,null,null,null,null,null,null];
(statearr_61808[(0)] = predict_prostate$pages$model_tests$click_handler_$_state_machine__29950__auto__);

(statearr_61808[(1)] = (1));

return statearr_61808;
});
var predict_prostate$pages$model_tests$click_handler_$_state_machine__29950__auto____1 = (function (state_61806){
while(true){
var ret_value__29951__auto__ = (function (){try{while(true){
var result__29952__auto__ = switch__29949__auto__(state_61806);
...
}catch (e61809){var ex__29953__auto__ = e61809;
var statearr_61810_61817 = state_61806;
(statearr_61810_61817[(2)] = ex__29953__auto__);


if(cljs.core.seq((state_61806[(4)]))){
var statearr_61811_61818 = state_61806;
(statearr_61811_61818[(1)] = cljs.core.first((state_61806[(4)])));
...
var G__61819 = state_61806;
state_61806 = G__61819;
continue;
} else {
...
predict_prostate$pages$model_tests$click_handler_$_state_machine__29950__auto__ = function(state_61806){
switch(arguments.length){
case 0:
return predict_prostate$pages$model_tests$click_handler_$_state_machine__29950__auto____0.call(this);
case 1:
return predict_prostate$pages$model_tests$click_handler_$_state_machine__29950__auto____1.call(this,state_61806);
}
...
var state__30021__auto__ = (function (){var statearr_61812 = f__30020__auto__();
(statearr_61812[(6)] = c__30019__auto__);
