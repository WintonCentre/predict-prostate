...
var default_47404 = predict_prostate.state.config.get_input_default(predict_prostate.state.config.input_groups,key);
pubsub.feeds.publish(predict_prostate.state.run_time.input_change(key),default_47404);
...
var cs = (function (){var G__47332 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"conservative-survival","conservative-survival",-852356338).cljs$core$IFn$_invoke$arity$1(data),years);
return (predict_prostate.results.text.round.cljs$core$IFn$_invoke$arity$1 ? predict_prostate.results.text.round.cljs$core$IFn$_invoke$arity$1(G__47332) : predict_prostate.results.text.round.call(null,G__47332));
})();
var rs = (function (){var G__47333 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"radical-survival","radical-survival",-74207469).cljs$core$IFn$_invoke$arity$1(data),years);
return (predict_prostate.results.text.round.cljs$core$IFn$_invoke$arity$1 ? predict_prostate.results.text.round.cljs$core$IFn$_invoke$arity$1(G__47333) : predict_prostate.results.text.round.call(null,G__47333));
})();
var benefit = (rs - cs);
return React.createElement("div",({"className": "row"}),React.createElement("div",({"className": "print-only"}),React.createElement("div",({"style": ({"marginTop": (0), "marginBottom": "0px", "display": "inline-block", "fontSize": (12)}), "className": "col-sm-12 print-only"}),"Based on the information you have entered, ",(function (){var attrs47334 = predict_prostate.results.text.emph(cs);
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(React.createElement,"p",((cljs.core.map_QMARK_(attrs47334))?sablono.interpreter.attributes(attrs47334):null),((cljs.core.map_QMARK_(attrs47334))?new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [" out of ",sablono.interpreter.interpret(predict_prostate.results.text.emph((100)))," men are alive at years with ",sablono.interpreter.interpret(predict_prostate.results.text.emph("initial conservative manage,ent")),"."], null):new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret(attrs47334)," out of ",sablono.interpreter.interpret(predict_prostate.results.text.emph((100)))," men are alive at years with ",sablono.interpreter.interpret(predict_prostate.results.text.emph("initial conservative manage,ent")),"."], null)));
})(),sablono.interpreter.interpret((cljs.core.truth_(radical_QMARK_)?new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),predict_prostate.results.text.emph(rs)," out of ",predict_prostate.results.text.emph((100))," men treated (an extra ",predict_prostate.results.text.emph(benefit),") are alive because of ",predict_prostate.results.text.emph("radical treatment"),"."], null):null)))),React.createElement("div",({"className": "screen-only"}),React.createElement("div",({"style": ({"marginTop": (15), "marginBottom": "0px", "display": "inline-block", "fontSize": (16)}), "className": "col-sm-12"}),React.createElement("span",null,"Based on the information you have entered, ",sablono.interpreter.interpret((predict_prostate.components.button.year_picker.cljs$core$IFn$_invoke$arity$0 ? predict_prostate.components.button.year_picker.cljs$core$IFn$_invoke$arity$0() : predict_prostate.components.button.year_picker.call(null)))," years after diagnosis:"),(function (){var attrs47337 = predict_prostate.results.text.emph(cs);
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(React.createElement,"p",((cljs.core.map_QMARK_(attrs47337))?sablono.interpreter.attributes(attrs47337):null),((cljs.core.map_QMARK_(attrs47337))?new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [" out of ",sablono.interpreter.interpret(predict_prostate.results.text.emph((100)))," men are alive at ",sablono.interpreter.interpret(years)," years with ",sablono.interpreter.interpret(predict_prostate.results.text.emph("initial conservative treatment")),"."], null):new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret(attrs47337)," out of ",sablono.interpreter.interpret(predict_prostate.results.text.emph((100)))," men are alive at ",sablono.interpreter.interpret(years)," years with ",sablono.interpreter.interpret(predict_prostate.results.text.emph("initial conservative treatment")),"."], null)));
...
var one_sum = (function (p1__47338_SHARP_,p2__47339_SHARP_){
return ((100) * ((1) - (p1__47338_SHARP_ + p2__47339_SHARP_)));
});
...
predict_prostate.results.text.results_in_text = rum.core.build_defc((function (p__47365){
...
var printable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47366__$1,new cljs.core.Keyword(null,"printable","printable",-928999004));
...
var attrs47343 = (predict_prostate.results.text.texts.cljs$core$IFn$_invoke$arity$4 ? predict_prostate.results.text.texts.cljs$core$IFn$_invoke$arity$4(year,data,radical_QMARK_,printable) : predict_prostate.results.text.texts.call(null,year,data,radical_QMARK_,printable));
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(React.createElement,"div",((cljs.core.map_QMARK_(attrs47343))?sablono.interpreter.attributes(attrs47343):null),((cljs.core.map_QMARK_(attrs47343))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [React.createElement("p",({"style": ({"fontSize": (12)}), "className": "print-only"}),sablono.interpreter.interpret(text1),sablono.interpreter.interpret(predict_prostate.results.text.emph((function (){var G__47393 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"dotted-orange","dotted-orange",-573056274).cljs$core$IFn$_invoke$arity$1(data),year);
return (predict_prostate.results.text.round.cljs$core$IFn$_invoke$arity$1 ? predict_prostate.results.text.round.cljs$core$IFn$_invoke$arity$1(G__47393) : predict_prostate.results.text.round.call(null,G__47393));
})())),sablono.interpreter.interpret(text2)),React.createElement("p",({"style": ({"fontSize": (16)}), "className": "screen-only"}),sablono.interpreter.interpret(text1),sablono.interpreter.interpret(predict_prostate.results.text.emph((function (){var G__47397 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"dotted-orange","dotted-orange",-573056274).cljs$core$IFn$_invoke$arity$1(data),year);
return (predict_prostate.results.text.round.cljs$core$IFn$_invoke$arity$1 ? predict_prostate.results.text.round.cljs$core$IFn$_invoke$arity$1(G__47397) : predict_prostate.results.text.round.call(null,G__47397));
})())),sablono.interpreter.interpret(text2))], null):new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret(attrs47343),React.createElement("p",({"style": ({"fontSize": (12)}), "className": "print-only"}),sablono.interpreter.interpret(text1),sablono.interpreter.interpret(predict_prostate.results.text.emph((function (){var G__47399 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"dotted-orange","dotted-orange",-573056274).cljs$core$IFn$_invoke$arity$1(data),year);
return (predict_prostate.results.text.round.cljs$core$IFn$_invoke$arity$1 ? predict_prostate.results.text.round.cljs$core$IFn$_invoke$arity$1(G__47399) : predict_prostate.results.text.round.call(null,G__47399));
})())),sablono.interpreter.interpret(text2)),React.createElement("p",({"style": ({"fontSize": (16)}), "className": "screen-only"}),sablono.interpreter.interpret(text1),sablono.interpreter.interpret(predict_prostate.results.text.emph((function (){var G__47400 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"dotted-orange","dotted-orange",-573056274).cljs$core$IFn$_invoke$arity$1(data),year);
return (predict_prostate.results.text.round.cljs$core$IFn$_invoke$arity$1 ? predict_prostate.results.text.round.cljs$core$IFn$_invoke$arity$1(G__47400) : predict_prostate.results.text.round.call(null,G__47400));
