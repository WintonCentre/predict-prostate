...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_36191 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_36191(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_36192 = (function (runtime,key,spec){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_36192(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_36193 = (function (runtime,key){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_36193(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_36198 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_36198(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_36199 = (function (runtime,input,callback){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_36199(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_36202 = (function (runtime,code){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_36202(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__36186,callback){
var map__36187 = p__36186;
var map__36187__$1 = cljs.core.__destructure_map(map__36187);
var input = map__36187__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36187__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36187__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
