...
var mql_50027 = window.matchMedia("print");
mql_50027.addListener((function (p1__50021_SHARP_){
if(cljs.core.truth_(goog.object.get(p1__50021_SHARP_,"matches"))){
...
var vec__50023 = rum.core.react(predict_prostate.state.run_time.route);
var page = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50023,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50023,(1),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50023,(2),null);
var rt = vec__50023;
...
var attrs50022 = (function (){var G__50026 = page;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50026__$1)].join('')));

}
})();
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(React.createElement,"div",((cljs.core.map_QMARK_(attrs50022))?sablono.interpreter.attributes(attrs50022):null),((cljs.core.map_QMARK_(attrs50022))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret(attrs50022)], null)));
