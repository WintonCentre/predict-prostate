...
var mql_43982 = window.matchMedia("print");
mql_43982.addListener((function (p1__43976_SHARP_){
if(cljs.core.truth_(goog.object.get(p1__43976_SHARP_,"matches"))){
...
var vec__43978 = rum.core.react(predict_prostate.state.run_time.route);
var page = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43978,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43978,(1),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43978,(2),null);
var rt = vec__43978;
...
var attrs43977 = (function (){var G__43981 = page;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__43981__$1)].join('')));

}
})();
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(React.createElement,"div",((cljs.core.map_QMARK_(attrs43977))?sablono.interpreter.attributes(attrs43977):null),((cljs.core.map_QMARK_(attrs43977))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret(attrs43977)], null)));
