...
var mql_35134 = window.matchMedia("print");
mql_35134.addListener((function (p1__35128_SHARP_){
if(cljs.core.truth_(goog.object.get(p1__35128_SHARP_,"matches"))){
...
var vec__35130 = rum.core.react(predict_prostate.state.run_time.route);
var page = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35130,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35130,(1),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35130,(2),null);
var rt = vec__35130;
...
var attrs35129 = (function (){var G__35133 = page;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35133__$1)].join('')));

}
})();
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(React.createElement,"div",((cljs.core.map_QMARK_(attrs35129))?sablono.interpreter.attributes(attrs35129):null),((cljs.core.map_QMARK_(attrs35129))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret(attrs35129)], null)));
