...
var mql_49782 = window.matchMedia("print");
mql_49782.addListener((function (p1__49776_SHARP_){
if(cljs.core.truth_(goog.object.get(p1__49776_SHARP_,"matches"))){
...
var vec__49778 = rum.core.react(predict_prostate.state.run_time.route);
var page = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49778,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49778,(1),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49778,(2),null);
var rt = vec__49778;
...
var attrs49777 = (function (){var G__49781 = page;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__49781__$1)].join('')));

}
})();
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(React.createElement,"div",((cljs.core.map_QMARK_(attrs49777))?sablono.interpreter.attributes(attrs49777):null),((cljs.core.map_QMARK_(attrs49777))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret(attrs49777)], null)));
