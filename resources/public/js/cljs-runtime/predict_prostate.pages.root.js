...
var mql_49565 = window.matchMedia("print");
mql_49565.addListener((function (p1__49559_SHARP_){
if(cljs.core.truth_(goog.object.get(p1__49559_SHARP_,"matches"))){
...
var vec__49561 = rum.core.react(predict_prostate.state.run_time.route);
var page = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49561,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49561,(1),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49561,(2),null);
var rt = vec__49561;
...
var attrs49560 = (function (){var G__49564 = page;
var G__49564__$1 = (((G__49564 instanceof cljs.core.Keyword))?G__49564.fqn:null);
switch (G__49564__$1) {
case "home":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__49564__$1)].join('')));

}
})();
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(React.createElement,"div",((cljs.core.map_QMARK_(attrs49560))?sablono.interpreter.attributes(attrs49560):null),((cljs.core.map_QMARK_(attrs49560))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret(attrs49560)], null)));
