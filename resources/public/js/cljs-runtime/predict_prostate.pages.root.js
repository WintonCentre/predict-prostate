...
var mql_140290 = window.matchMedia("print");
mql_140290.addListener((function (p1__140278_SHARP_){
if(cljs.core.truth_(goog.object.get(p1__140278_SHARP_,"matches"))){
...
var vec__140281 = rum.core.react(predict_prostate.state.run_time.route);
var page = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__140281,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__140281,(1),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__140281,(2),null);
var rt = vec__140281;
...
var attrs140280 = (function (){var G__140287 = page;
var G__140287__$1 = (((G__140287 instanceof cljs.core.Keyword))?G__140287.fqn:null);
switch (G__140287__$1) {
case "home":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__140287__$1)].join('')));

}
})();
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(React.createElement,"div",((cljs.core.map_QMARK_(attrs140280))?sablono.interpreter.attributes(attrs140280):null),((cljs.core.map_QMARK_(attrs140280))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret(attrs140280)], null)));
