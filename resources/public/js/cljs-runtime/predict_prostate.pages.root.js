...
var mql_37137 = window.matchMedia("print");
mql_37137.addListener((function (p1__37131_SHARP_){
if(cljs.core.truth_(goog.object.get(p1__37131_SHARP_,"matches"))){
...
var vec__37133 = rum.core.react(predict_prostate.state.run_time.route);
var page = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37133,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37133,(1),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37133,(2),null);
var rt = vec__37133;
...
var attrs37132 = (function (){var G__37136 = page;
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(React.createElement,"div",((cljs.core.map_QMARK_(attrs37132))?sablono.interpreter.attributes(attrs37132):null),((cljs.core.map_QMARK_(attrs37132))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret(attrs37132)], null)));
