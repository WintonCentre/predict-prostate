...
var mql_163801 = window.matchMedia("print");
mql_163801.addListener((function (p1__163789_SHARP_){
if(cljs.core.truth_(goog.object.get(p1__163789_SHARP_,"matches"))){
...
var vec__163791 = rum.core.react(predict_prostate.state.run_time.route);
var page = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__163791,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__163791,(1),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__163791,(2),null);
var rt = vec__163791;
...
var attrs163790 = (function (){var G__163794 = page;
var G__163794__$1 = (((G__163794 instanceof cljs.core.Keyword))?G__163794.fqn:null);
switch (G__163794__$1) {
case "home":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__163794__$1)].join('')));

}
})();
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(React.createElement,"div",((cljs.core.map_QMARK_(attrs163790))?sablono.interpreter.attributes(attrs163790):null),((cljs.core.map_QMARK_(attrs163790))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret(attrs163790)], null)));
