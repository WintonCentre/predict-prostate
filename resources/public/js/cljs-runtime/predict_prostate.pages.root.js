...
var mql_35578 = window.matchMedia("print");
mql_35578.addListener((function (p1__35572_SHARP_){
if(cljs.core.truth_(goog.object.get(p1__35572_SHARP_,"matches"))){
...
var vec__35574 = rum.core.react(predict_prostate.state.run_time.route);
var page = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35574,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35574,(1),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35574,(2),null);
var rt = vec__35574;
...
var attrs35573 = (function (){var G__35577 = page;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35577__$1)].join('')));

}
})();
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(React.createElement,"div",((cljs.core.map_QMARK_(attrs35573))?sablono.interpreter.attributes(attrs35573):null),((cljs.core.map_QMARK_(attrs35573))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret(attrs35573)], null)));
