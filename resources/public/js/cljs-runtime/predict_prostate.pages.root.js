...
var mql_45591 = window.matchMedia("print");
mql_45591.addListener((function (p1__45580_SHARP_){
if(cljs.core.truth_(goog.object.get(p1__45580_SHARP_,"matches"))){
...
var vec__45583 = rum.core.react(predict_prostate.state.run_time.route);
var page = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45583,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45583,(1),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45583,(2),null);
var rt = vec__45583;
...
var attrs45582 = (function (){var G__45586 = page;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__45586__$1)].join('')));

}
})();
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(React.createElement,"div",((cljs.core.map_QMARK_(attrs45582))?sablono.interpreter.attributes(attrs45582):null),((cljs.core.map_QMARK_(attrs45582))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret(attrs45582)], null)));
