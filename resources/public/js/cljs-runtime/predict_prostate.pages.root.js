...
var mql_34653 = window.matchMedia("print");
mql_34653.addListener((function (p1__34647_SHARP_){
if(cljs.core.truth_(goog.object.get(p1__34647_SHARP_,"matches"))){
...
var vec__34649 = rum.core.react(predict_prostate.state.run_time.route);
var page = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34649,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34649,(1),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34649,(2),null);
var rt = vec__34649;
...
var attrs34648 = (function (){var G__34652 = page;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__34652__$1)].join('')));

}
})();
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(React.createElement,"div",((cljs.core.map_QMARK_(attrs34648))?sablono.interpreter.attributes(attrs34648):null),((cljs.core.map_QMARK_(attrs34648))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret(attrs34648)], null)));
