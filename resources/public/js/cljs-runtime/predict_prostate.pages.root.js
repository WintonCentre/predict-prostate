...
var mql_42999 = window.matchMedia("print");
mql_42999.addListener((function (p1__42993_SHARP_){
if(cljs.core.truth_(goog.object.get(p1__42993_SHARP_,"matches"))){
...
var vec__42995 = rum.core.react(predict_prostate.state.run_time.route);
var page = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42995,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42995,(1),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42995,(2),null);
var rt = vec__42995;
...
var attrs42994 = (function (){var G__42998 = page;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42998__$1)].join('')));

}
})();
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(React.createElement,"div",((cljs.core.map_QMARK_(attrs42994))?sablono.interpreter.attributes(attrs42994):null),((cljs.core.map_QMARK_(attrs42994))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret(attrs42994)], null)));
