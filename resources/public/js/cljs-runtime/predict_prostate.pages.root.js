...
var mql_43337 = window.matchMedia("print");
mql_43337.addListener((function (p1__43331_SHARP_){
if(cljs.core.truth_(goog.object.get(p1__43331_SHARP_,"matches"))){
...
var vec__43333 = rum.core.react(predict_prostate.state.run_time.route);
var page = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43333,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43333,(1),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43333,(2),null);
var rt = vec__43333;
...
var attrs43332 = (function (){var G__43336 = page;
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(React.createElement,"div",((cljs.core.map_QMARK_(attrs43332))?sablono.interpreter.attributes(attrs43332):null),((cljs.core.map_QMARK_(attrs43332))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret(attrs43332)], null)));
