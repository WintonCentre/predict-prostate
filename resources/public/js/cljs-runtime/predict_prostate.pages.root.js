...
var mql_37322 = window.matchMedia("print");
mql_37322.addListener((function (p1__37316_SHARP_){
if(cljs.core.truth_(goog.object.get(p1__37316_SHARP_,"matches"))){
...
var vec__37318 = rum.core.react(predict_prostate.state.run_time.route);
var page = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37318,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37318,(1),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37318,(2),null);
var rt = vec__37318;
...
var attrs37317 = (function (){var G__37321 = page;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__37321__$1)].join('')));

}
})();
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(React.createElement,"div",((cljs.core.map_QMARK_(attrs37317))?sablono.interpreter.attributes(attrs37317):null),((cljs.core.map_QMARK_(attrs37317))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret(attrs37317)], null)));
