...
var mql_45147 = window.matchMedia("print");
mql_45147.addListener((function (p1__45136_SHARP_){
if(cljs.core.truth_(goog.object.get(p1__45136_SHARP_,"matches"))){
...
var vec__45139 = rum.core.react(predict_prostate.state.run_time.route);
var page = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45139,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45139,(1),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45139,(2),null);
var rt = vec__45139;
...
var attrs45137 = (function (){var G__45146 = page;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__45146__$1)].join('')));

}
})();
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(React.createElement,"div",((cljs.core.map_QMARK_(attrs45137))?sablono.interpreter.attributes(attrs45137):null),((cljs.core.map_QMARK_(attrs45137))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret(attrs45137)], null)));
