...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__30185_SHARP_){
return (((p1__30185_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__30185_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__30197,new cljs.core.Keyword(null,"class","class",-2030961996),daiquiri.normalize.normalize_class);
} else {
return G__30197;
}
});
...
var len__4818__auto___30259 = arguments.length;
var i__4819__auto___30260 = (0);
while(true){
if((i__4819__auto___30260 < len__4818__auto___30259)){
args__4824__auto__.push((arguments[i__4819__auto___30260]));

var G__30261 = (i__4819__auto___30260 + (1));
i__4819__auto___30260 = G__30261;
continue;
} else {
}
break;
...
var G__30215 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__30215,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__30215;
}
} else {
...
/** @this {Function} */
(daiquiri.normalize.merge_with_class.cljs$lang$applyTo = (function (seq30214){
var self__4806__auto__ = this;
return self__4806__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq30214));
}));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30218,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30218,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,daiquiri.normalize.strip_css(cljs.core.some((function (p1__30216_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__30216_SHARP_))){
return p1__30216_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$1((function (p1__30217_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__30217_SHARP_))){
return daiquiri.normalize.strip_css(p1__30217_SHARP_);
} else {
return null;
}
})),names)], null);
 ...
 */
daiquiri.normalize.element = (function daiquiri$normalize$element(p__30248){
...
var tag = first__30251;
var content = seq__30250__$1;
...
var vec__30255 = daiquiri.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30255,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30255,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30255,(2),null);
var tag_attrs = (function (){var G__30258 = cljs.core.PersistentArrayMap.EMPTY;
var G__30258__$1 = (((!(cljs.core.empty_QMARK_(id))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__30258,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__30258);
if((!(cljs.core.empty_QMARK_(class$)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__30258__$1,new cljs.core.Keyword(null,"class","class",-2030961996),class$);
} else {
return G__30258__$1;
}
})();
