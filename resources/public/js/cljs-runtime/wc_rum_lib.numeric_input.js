...
var vec__46982 = temp__5751__auto__;
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46982,(0),null);
var m1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46982,(1),null);
return m1;
} else {
return s;
}
...
var G__46992 = wc_rum_lib.numeric_input.num_to_str.cljs$core$IFn$_invoke$arity$2(v,precision);
return (onChange.cljs$core$IFn$_invoke$arity$1 ? onChange.cljs$core$IFn$_invoke$arity$1(G__46992) : onChange.call(null,G__46992));
});
...
var G__47085 = wc_rum_lib.numeric_input.num_to_str.cljs$core$IFn$_invoke$arity$2(wc_rum_lib.numeric_input.validate_input(wc_rum_lib.numeric_input.str_to_num(value),nmin,nmax,(0)),precision);
return (onChange.cljs$core$IFn$_invoke$arity$1 ? onChange.cljs$core$IFn$_invoke$arity$1(G__47085) : onChange.call(null,G__47085));
} else {
...
wc_rum_lib.numeric_input.inc_dec_button = rum.core.build_defcs((function (state,p__47099){
var map__47100 = p__47099;
var map__47100__$1 = cljs.core.__destructure_map(map__47100);
var props = map__47100__$1;
var cursor = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47100__$1,new cljs.core.Keyword(null,"cursor","cursor",1011937484));
var increment = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47100__$1,new cljs.core.Keyword(null,"increment","increment",-1558831484));
var onChange = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47100__$1,new cljs.core.Keyword(null,"onChange","onChange",-312891301));
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47100__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47100__$1,new cljs.core.Keyword(null,"max","max",61366548));
var nmin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47100__$1,new cljs.core.Keyword(null,"nmin","nmin",1751665282));
var nmax = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47100__$1,new cljs.core.Keyword(null,"nmax","nmax",608994404));
var precision = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47100__$1,new cljs.core.Keyword(null,"precision","precision",-1175707478));
...
wc_rum_lib.numeric_input.numeric_input = rum.core.build_defc((function (p__47112){
var map__47113 = p__47112;
var map__47113__$1 = cljs.core.__destructure_map(map__47113);
var props = map__47113__$1;
var onChange = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47113__$1,new cljs.core.Keyword(null,"onChange","onChange",-312891301));
var step = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47113__$1,new cljs.core.Keyword(null,"step","step",1288888124));
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47113__$1,new cljs.core.Keyword(null,"min","min",444991522));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47113__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__47113__$1,new cljs.core.Keyword(null,"color","color",1011675173),"black");
var input_ref = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47113__$1,new cljs.core.Keyword(null,"input-ref","input-ref",575432746));
var precision = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47113__$1,new cljs.core.Keyword(null,"precision","precision",-1175707478));
var error_color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__47113__$1,new cljs.core.Keyword(null,"error-color","error-color",-332587474),"red");
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47113__$1,new cljs.core.Keyword(null,"max","max",61366548));
var vec__47114 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(rum.core.react(input_ref),/:/);
var good = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47114,(0),null);
var bad = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47114,(1),null);
...
return React.createElement("div",({"style": ({"minWidth": "100px", "tabIndex": (1), "selectable": true}), "onKeyDown": (function (p1__47106_SHARP_){
var key_code = p1__47106_SHARP_.nativeEvent.code;
if(cljs.core.truth_((function (){var fexpr__47118 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["ArrowUp",null,"ArrowDown",null], null), null);
return (fexpr__47118.cljs$core$IFn$_invoke$arity$1 ? fexpr__47118.cljs$core$IFn$_invoke$arity$1(key_code) : fexpr__47118.call(null,key_code));
})())){
p1__47106_SHARP_.preventDefault();
} else {
}
...
}), "className": "numeric-input"}),(function (){var attrs47117 = (function (){var G__47119 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(props,new cljs.core.Keyword(null,"nmin","nmin",1751665282),nmin,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"nmax","nmax",608994404),nmax,new cljs.core.Keyword(null,"precision","precision",-1175707478),precision,new cljs.core.Keyword(null,"increment","increment",-1558831484),((-1) * step),new cljs.core.Keyword(null,"cursor","cursor",1011937484),input_ref], 0));
return (wc_rum_lib.numeric_input.inc_dec_button.cljs$core$IFn$_invoke$arity$1 ? wc_rum_lib.numeric_input.inc_dec_button.cljs$core$IFn$_invoke$arity$1(G__47119) : wc_rum_lib.numeric_input.inc_dec_button.call(null,G__47119));
})();
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(React.createElement,"div",((cljs.core.map_QMARK_(attrs47117))?sablono.interpreter.attributes(sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["button-group"], null)], null),attrs47117], 0))):({"className": "button-group"})),((cljs.core.map_QMARK_(attrs47117))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.create_element("input",({"type": "text", "value": good, "id": key, "onClick": mutate, "onChange": mutate2, "style": ({"color": (((bad == null))?color:error_color), "borderTop": "2px solid #ddd", "width": "58px", "padding": "0 0 4px 0", "borderLeft": "2px solid #ddd", "textAlign": "center", "fontSize": "14px", "backgroundColor": (cljs.core.truth_(isNaN(value))?"#fff":"#CCEEF8"), "height": "36px"})})),sablono.interpreter.interpret((function (){var G__47120 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(props,new cljs.core.Keyword(null,"nmin","nmin",1751665282),nmin,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"nmax","nmax",608994404),nmax,new cljs.core.Keyword(null,"precision","precision",-1175707478),precision,new cljs.core.Keyword(null,"increment","increment",-1558831484),step,new cljs.core.Keyword(null,"cursor","cursor",1011937484),input_ref], 0));
return (wc_rum_lib.numeric_input.inc_dec_button.cljs$core$IFn$_invoke$arity$1 ? wc_rum_lib.numeric_input.inc_dec_button.cljs$core$IFn$_invoke$arity$1(G__47120) : wc_rum_lib.numeric_input.inc_dec_button.call(null,G__47120));
})())], null):new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret(attrs47117),sablono.interpreter.create_element("input",({"type": "text", "value": good, "id": key, "onClick": mutate, "onChange": mutate2, "style": ({"color": (((bad == null))?color:error_color), "borderTop": "2px solid #ddd", "width": "58px", "padding": "0 0 4px 0", "borderLeft": "2px solid #ddd", "textAlign": "center", "fontSize": "14px", "backgroundColor": (cljs.core.truth_(isNaN(value))?"#fff":"#CCEEF8"), "height": "36px"})})),sablono.interpreter.interpret((function (){var G__47121 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(props,new cljs.core.Keyword(null,"nmin","nmin",1751665282),nmin,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"nmax","nmax",608994404),nmax,new cljs.core.Keyword(null,"precision","precision",-1175707478),precision,new cljs.core.Keyword(null,"increment","increment",-1558831484),step,new cljs.core.Keyword(null,"cursor","cursor",1011937484),input_ref], 0));
return (wc_rum_lib.numeric_input.inc_dec_button.cljs$core$IFn$_invoke$arity$1 ? wc_rum_lib.numeric_input.inc_dec_button.cljs$core$IFn$_invoke$arity$1(G__47121) : wc_rum_lib.numeric_input.inc_dec_button.call(null,G__47121));
})())], null)));
})());
