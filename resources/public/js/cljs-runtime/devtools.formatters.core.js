...
}catch (e32886){var _e__30231__auto__ = e32886;
return false;
...
}catch (e32898){var _e__30231__auto__ = e32898;
return false;
...
}catch (e32912){var _e__30231__auto__ = e32912;
return false;
...
}catch (e32915){var _e__30231__auto__ = e32915;
return false;
...
}catch (e32921){var _e__30231__auto__ = e32921;
return false;
}})())){
...
}catch (e32923){var _e__30231__auto__ = e32923;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__32926 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__32927 = (function (){var or__4126__auto__ = config;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__32927);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__32926);
}});
});
...
while (G__32942__i < G__32942__a.length) {G__32942__a[G__32942__i] = arguments[G__32942__i + 0]; ++G__32942__i;}
  args = new cljs.core.IndexedSeq(G__32942__a,0,null);
} 
