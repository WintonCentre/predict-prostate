...
tongue.core.format_inst_iso = (function (){var G__42797 = "{year}-{month-numeric-padded}-{day-padded}T{hour24-padded}:{minutes-padded}:{seconds-padded}";
var G__42798 = cljs.core.PersistentArrayMap.EMPTY;
return (tongue.core.inst_formatter.cljs$core$IFn$_invoke$arity$2 ? tongue.core.inst_formatter.cljs$core$IFn$_invoke$arity$2(G__42797,G__42798) : tongue.core.inst_formatter.call(null,G__42797,G__42798));
})();
...
var or__4212__auto__ = (function (){var fexpr__42802 = cljs.core.deref(tongue.core.tags_cache);
return (fexpr__42802.cljs$core$IFn$_invoke$arity$1 ? fexpr__42802.cljs$core$IFn$_invoke$arity$1(locale) : fexpr__42802.call(null,locale));
})();
...
var G__42948 = cljs.core.next(subtags);
var G__42949 = tag;
var G__42950 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(tags,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(tag));
subtags = G__42948;
last_tag = G__42949;
tags = G__42950;
continue;
...
var G__42952 = cljs.core.next(tags);
tags = G__42952;
continue;
}
}
...
var tongue$core$IInterpolate$interpolate_named$dyn_42954 = (function (v,dicts,locale,interpolations){
...
return tongue$core$IInterpolate$interpolate_named$dyn_42954(v,dicts,locale,interpolations);
}
});

var tongue$core$IInterpolate$interpolate_positional$dyn_42955 = (function (v,dicts,locale,interpolations){
var x__4509__auto__ = (((v == null))?null:v);
...
return tongue$core$IInterpolate$interpolate_positional$dyn_42955(v,dicts,locale,interpolations);
}
});
...
return clojure.string.replace(s,/\{([\w*!_?$%&=<>'\-+.#0-9]+|[\w*!_?$%&=<>'\-+.#0-9]+\/[\w*!_?$%&=<>'\-+.#0-9:]+)\}/,(function (p__42857){
var vec__42858 = p__42857;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42858,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42858,(1),null);
...
return clojure.string.replace(s,/\{(\d+)\}/,(function (p__42864){
var vec__42865 = p__42864;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42865,(0),null);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42865,(1),null);
...
var len__4818__auto___42968 = arguments.length;
var i__4819__auto___42970 = (0);
while(true){
if((i__4819__auto___42970 < len__4818__auto___42968)){
args_arr__4839__auto__.push((arguments[i__4819__auto___42970]));

var G__42971 = (i__4819__auto___42970 + (1));
i__4819__auto___42970 = G__42971;
continue;
} else {
}
break;
...
/** @this {Function} */
(tongue.core.translate.cljs$lang$applyTo = (function (seq42888){
var G__42889 = cljs.core.first(seq42888);
var seq42888__$1 = cljs.core.next(seq42888);
var G__42891 = cljs.core.first(seq42888__$1);
var seq42888__$2 = cljs.core.next(seq42888__$1);
var G__42892 = cljs.core.first(seq42888__$2);
var seq42888__$3 = cljs.core.next(seq42888__$2);
var G__42893 = cljs.core.first(seq42888__$3);
var seq42888__$4 = cljs.core.next(seq42888__$3);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42889,G__42891,G__42892,G__42893,seq42888__$4);
}));
...
var G__42985 = val;
var G__42986 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path,v);
v = G__42985;
path = G__42986;
continue;
}
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42928_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.first(p1__42928_SHARP_),tongue.core.resolve_alias_1(m,cljs.core.second(p1__42928_SHARP_))],null));
}),m));
});
...
var G__42992 = function (locale,key,x,var_args){
var args = null;
if (arguments.length > 3) {
var G__42993__i = 0, G__42993__a = new Array(arguments.length -  3);
while (G__42993__i < G__42993__a.length) {G__42993__a[G__42993__i] = arguments[G__42993__i + 3]; ++G__42993__i;}
  args = new cljs.core.IndexedSeq(G__42993__a,0,null);
} 
return G__42992__delegate.call(this,locale,key,x,args);};
G__42992.cljs$lang$maxFixedArity = 3;
G__42992.cljs$lang$applyTo = (function (arglist__42996){
var locale = cljs.core.first(arglist__42996);
arglist__42996 = cljs.core.next(arglist__42996);
var key = cljs.core.first(arglist__42996);
arglist__42996 = cljs.core.next(arglist__42996);
var x = cljs.core.first(arglist__42996);
var args = cljs.core.rest(arglist__42996);
return G__42992__delegate(locale,key,x,args);
});
G__42992.cljs$core$IFn$_invoke$arity$variadic = G__42992__delegate;
return G__42992;
})()
;
G__42988 = function(locale,key,x,var_args){
var args = var_args;
switch(arguments.length){
case 2:
return G__42988__2.call(this,locale,key);
case 3:
return G__42988__3.call(this,locale,key,x);
default:
var G__42999 = null;
if (arguments.length > 3) {
var G__43000__i = 0, G__43000__a = new Array(arguments.length -  3);
while (G__43000__i < G__43000__a.length) {G__43000__a[G__43000__i] = arguments[G__43000__i + 3]; ++G__43000__i;}
G__42999 = new cljs.core.IndexedSeq(G__43000__a,0,null);
}
return G__42988__4.cljs$core$IFn$_invoke$arity$variadic(locale,key,x, G__42999);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__42988.cljs$lang$maxFixedArity = 3;
G__42988.cljs$lang$applyTo = G__42988__4.cljs$lang$applyTo;
G__42988.cljs$core$IFn$_invoke$arity$2 = G__42988__2;
G__42988.cljs$core$IFn$_invoke$arity$3 = G__42988__3;
G__42988.cljs$core$IFn$_invoke$arity$variadic = G__42988__4.cljs$core$IFn$_invoke$arity$variadic;
return G__42988;
})()
});
