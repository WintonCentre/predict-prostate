...
var G__43758 = request;
var G__43759 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__43758,G__43759) : ajax.formats.get_format.call(null,G__43758,G__43759));
} else {
...
return cljs.core.some((function (p1__43763_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__43763_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__43765){
var map__43766 = p__43765;
var map__43766__$1 = cljs.core.__destructure_map(map__43766);
var request = map__43766__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43766__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__43767 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__43767.cljs$core$IFn$_invoke$arity$1 ? fexpr__43767.cljs$core$IFn$_invoke$arity$1(response) : fexpr__43767.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__43770){
var map__43771 = p__43770;
var map__43771__$1 = cljs.core.__destructure_map(map__43771);
var request = map__43771__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43771__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__43769_SHARP_){
return ajax.formats.get_accept_entries(request,p1__43769_SHARP_);
