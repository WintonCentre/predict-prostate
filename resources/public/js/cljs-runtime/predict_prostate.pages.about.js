...
var vec__33440 = new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33440,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33440,(1),null);
var offsets = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33440,(2),null);
...
var vec__33455_33489 = new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state);
var __33490 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33455_33489,(0),null);
var vec__33458_33491 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33455_33489,(1),null);
var __33492__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33458_33491,(0),null);
var map__33461_33493 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33458_33491,(1),null);
var map__33461_33494__$1 = cljs.core.__destructure_map(map__33461_33493);
var page_33495 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33461_33494__$1,new cljs.core.Keyword(null,"page","page",849072397));
var scroll_section_33496 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33461_33494__$1,new cljs.core.Keyword(null,"section","section",-300141526));
var scroll_section_33497__$1 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(scroll_section_33496);
interop.utils.scrollTo((cljs.core.truth_(scroll_section_33497__$1)?cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(new cljs.core.Keyword("predict-prostate.pages.about","offsets","predict-prostate.pages.about/offsets",228292490).cljs$core$IFn$_invoke$arity$1(state)),cljs.core.name(scroll_section_33497__$1)):(0)));
...
var vec__33465 = route;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33465,(0),null);
var map__33469 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33465,(1),null);
var map__33469__$1 = cljs.core.__destructure_map(map__33469);
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33469__$1,new cljs.core.Keyword(null,"page","page",849072397));
var scroll_section = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33469__$1,new cljs.core.Keyword(null,"section","section",-300141526));
...
var vec__33470 = predict_prostate.content_reader.section.cljs$core$IFn$_invoke$arity$2(ttt,"tool-preamble");
...
var ___$1 = first__33472;
var preamble = seq__33471__$1;
return daiquiri.core.create_element("div",{'className':"container-fluid"},[predict_prostate.layout.header.header(ttt),predict_prostate.layout.header.header_banner(ttt,"about-preamble"),daiquiri.core.create_element("div",{'id':"main-content",'tabIndex':(-1),'className':"row"},[daiquiri.core.create_element("div",{'style':{'minHeight':"calc(100vh - 700px)"},'className':"col-sm-10 col-sm-offset-1 col-lg-8 col-lg-offset-2"},[(cljs.core.truth_(page__$1)?(function (){var sec = (cljs.core.truth_(scroll_section__$1)?cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__33463_SHARP_,p2__33462_SHARP_){
return rum.core.with_key(predict_prostate.pages.about.sectionc(p2__33462_SHARP_,ttt,new cljs.core.Keyword("predict-prostate.pages.about","offsets","predict-prostate.pages.about/offsets",228292490).cljs$core$IFn$_invoke$arity$1(state)),p1__33463_SHARP_);
