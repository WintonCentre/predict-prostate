...
var vec__34594 = new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state);
...
var offsets = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34594,(2),null);
...
var vec__34612_34659 = new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state);
var __34660 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34612_34659,(0),null);
var vec__34615_34661 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34612_34659,(1),null);
var __34662__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34615_34661,(0),null);
var map__34618_34663 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34615_34661,(1),null);
var map__34618_34664__$1 = cljs.core.__destructure_map(map__34618_34663);
var page_34665 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34618_34664__$1,new cljs.core.Keyword(null,"page","page",849072397));
var scroll_section_34666 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34618_34664__$1,new cljs.core.Keyword(null,"section","section",-300141526));
var scroll_section_34667__$1 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(scroll_section_34666);
interop.utils.scrollTo((cljs.core.truth_(scroll_section_34667__$1)?cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(new cljs.core.Keyword("predict-prostate.pages.about","offsets","predict-prostate.pages.about/offsets",228292490).cljs$core$IFn$_invoke$arity$1(state)),cljs.core.name(scroll_section_34667__$1)):(0)));
...
var vec__34648 = route;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34648,(0),null);
var map__34651 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34648,(1),null);
var map__34651__$1 = cljs.core.__destructure_map(map__34651);
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34651__$1,new cljs.core.Keyword(null,"page","page",849072397));
var scroll_section = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34651__$1,new cljs.core.Keyword(null,"section","section",-300141526));
...
var vec__34652 = predict_prostate.content_reader.section.cljs$core$IFn$_invoke$arity$2(ttt,"tool-preamble");
...
var ___$1 = first__34654;
var preamble = seq__34653__$1;
return daiquiri.core.create_element("div",{'className':"container-fluid"},[predict_prostate.layout.header.header(ttt),predict_prostate.layout.header.header_banner(ttt,"about-preamble"),daiquiri.core.create_element("div",{'id':"main-content",'tabIndex':(-1),'className':"row"},[daiquiri.core.create_element("div",{'style':{'minHeight':"calc(100vh - 700px)"},'className':"col-sm-10 col-sm-offset-1 col-lg-8 col-lg-offset-2"},[(cljs.core.truth_(page__$1)?(function (){var sec = (cljs.core.truth_(scroll_section__$1)?cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__34640_SHARP_,p2__34639_SHARP_){
return rum.core.with_key(predict_prostate.pages.about.sectionc(p2__34639_SHARP_,ttt,new cljs.core.Keyword("predict-prostate.pages.about","offsets","predict-prostate.pages.about/offsets",228292490).cljs$core$IFn$_invoke$arity$1(state)),p1__34640_SHARP_);
