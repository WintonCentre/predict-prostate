...
var vec__59677 = new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59677,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59677,(1),null);
var offsets = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59677,(2),null);
...
var vec__59692_59776 = new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state);
var __59777 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59692_59776,(0),null);
var vec__59695_59778 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59692_59776,(1),null);
var __59779__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59695_59778,(0),null);
var map__59698_59780 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59695_59778,(1),null);
var map__59698_59781__$1 = cljs.core.__destructure_map(map__59698_59780);
var page_59782 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59698_59781__$1,new cljs.core.Keyword(null,"page","page",849072397));
var scroll_section_59783 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59698_59781__$1,new cljs.core.Keyword(null,"section","section",-300141526));
var scroll_section_59784__$1 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(scroll_section_59783);
interop.utils.scrollTo((cljs.core.truth_(scroll_section_59784__$1)?cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(new cljs.core.Keyword("predict-prostate.pages.about","offsets","predict-prostate.pages.about/offsets",228292490).cljs$core$IFn$_invoke$arity$1(state)),cljs.core.name(scroll_section_59784__$1)):(0)));
...
var vec__59735 = route;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59735,(0),null);
var map__59738 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59735,(1),null);
var map__59738__$1 = cljs.core.__destructure_map(map__59738);
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59738__$1,new cljs.core.Keyword(null,"page","page",849072397));
var scroll_section = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59738__$1,new cljs.core.Keyword(null,"section","section",-300141526));
...
var vec__59739 = predict_prostate.content_reader.section.cljs$core$IFn$_invoke$arity$2(ttt,"tool-preamble");
...
var ___$1 = first__59741;
var preamble = seq__59740__$1;
return daiquiri.core.create_element("div",{'className':"container-fluid"},[predict_prostate.layout.header.header(ttt),predict_prostate.layout.header.header_banner(ttt,"about-preamble"),daiquiri.core.create_element("div",{'id':"main-content",'tabIndex':(-1),'className':"row"},[daiquiri.core.create_element("div",{'style':{'minHeight':"calc(100vh - 700px)"},'className':"col-sm-10 col-sm-offset-1 col-lg-8 col-lg-offset-2"},[(cljs.core.truth_(page__$1)?(function (){var sec = (cljs.core.truth_(scroll_section__$1)?cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__59720_SHARP_,p2__59719_SHARP_){
return rum.core.with_key(predict_prostate.pages.about.sectionc(p2__59719_SHARP_,ttt,new cljs.core.Keyword("predict-prostate.pages.about","offsets","predict-prostate.pages.about/offsets",228292490).cljs$core$IFn$_invoke$arity$1(state)),p1__59720_SHARP_);
