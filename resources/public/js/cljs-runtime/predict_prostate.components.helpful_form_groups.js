...
predict_prostate.components.helpful_form_groups.helpful_input = rum.core.build_defc((function (p__33466,children){
var map__33467 = p__33466;
var map__33467__$1 = cljs.core.__destructure_map(map__33467);
var props = map__33467__$1;
var ttt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33467__$1,new cljs.core.Keyword(null,"ttt","ttt",1858561240));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33467__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33467__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33467__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var help_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33467__$1,new cljs.core.Keyword(null,"help-id","help-id",-1064550845));
return React.createElement("div",({"key": key, "data-key": key, "style": ({"verticalAlign": "top", "width": "100%", "display": "inline-block"}), "className": sablono.util.join_classes(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [["form-group",(cljs.core.truth_(error)?" has-error":"")].join('')], null))}),React.createElement("div",({"style": ({"display": "inline-block", "marginLeft": "10px", "width": "30px", "verticalAlign": "middle"})}),sablono.interpreter.interpret((cljs.core.truth_(help_id)?(function (){var G__33495 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"help-id","help-id",-1064550845),help_id], null);
return (predict_prostate.components.button.small_help_button.cljs$core$IFn$_invoke$arity$1 ? predict_prostate.components.button.small_help_button.cljs$core$IFn$_invoke$arity$1(G__33495) : predict_prostate.components.button.small_help_button.call(null,G__33495));
...
predict_prostate.components.helpful_form_groups.form_entry = rum.core.build_defc((function (p__33506){
var map__33507 = p__33506;
var map__33507__$1 = cljs.core.__destructure_map(map__33507);
var ttt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33507__$1,new cljs.core.Keyword(null,"ttt","ttt",1858561240));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33507__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33507__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
return sablono.interpreter.interpret((function (){var G__33509 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"ttt","ttt",1858561240),(cljs.core.truth_(ttt)?ttt:rum.core.react(predict_prostate.state.run_time.ttt_cursor)),new cljs.core.Keyword(null,"label","label",1718410804),predict_prostate.state.run_time.input_label(key),new cljs.core.Keyword(null,"key","key",-1516042587),key,new cljs.core.Keyword(null,"help-id","help-id",-1064550845),(cljs.core.truth_(label)?clojure.string.replace(clojure.string.lower_case(label)," ","-"):null),new cljs.core.Keyword(null,"error","error",-978969032),predict_prostate.state.run_time.error_QMARK_(rum.core.react(predict_prostate.state.run_time.input_cursor(key)))], null);
var G__33510 = predict_prostate.state.load_config.render_widget(ttt,key);
return (predict_prostate.components.helpful_form_groups.helpful_input.cljs$core$IFn$_invoke$arity$2 ? predict_prostate.components.helpful_form_groups.helpful_input.cljs$core$IFn$_invoke$arity$2(G__33509,G__33510) : predict_prostate.components.helpful_form_groups.helpful_input.call(null,G__33509,G__33510));
})());
