...
var vec__36764 = translations.root._ttt(rum.core.react(predict_prostate.state.run_time.ttt_cursor),arg);
var lang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36764,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36764,(1),null);
var attrs36763 = text;
return daiquiri.core.create_element("span",((cljs.core.map_QMARK_(attrs36763))?daiquiri.interpreter.element_attributes(attrs36763):null),((cljs.core.map_QMARK_(attrs36763))?null:[daiquiri.interpreter.interpret(attrs36763)]));
...
var vec__36775 = translations.root._ttt(rum.core.react(predict_prostate.state.run_time.ttt_cursor),arg);
var lang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36775,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36775,(1),null);
...
return daiquiri.core.create_element("span",{'style':{'backgroundColor':"#e488",'color':"#fff",'border':"1px dashed #e48"},'onClick':(function (p1__36773_SHARP_){
predict_prostate.state.run_time.edit_change.pubsub$feeds$TopicFeed$publish$arity$2(null,arg);

return p1__36773_SHARP_.stopPropagation();
})},[daiquiri.interpreter.interpret(text)]);
} else {
return daiquiri.core.create_element("span",{'style':{'backgroundColor':"#e482",'minWidth':"1ex",'minHeight':"10px",'border':((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(text,""))?"1px solid red":"1px solid #ccc")},'onClick':(function (p1__36774_SHARP_){
predict_prostate.state.run_time.edit_change.pubsub$feeds$TopicFeed$publish$arity$2(null,arg);

return p1__36774_SHARP_.stopPropagation();
})},[daiquiri.interpreter.interpret(text)]);
}
