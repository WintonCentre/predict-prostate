...
var vec__48503 = translations.root._ttt(rum.core.react(predict_prostate.state.run_time.ttt_cursor),arg);
var lang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48503,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48503,(1),null);
var attrs48501 = text;
return daiquiri.core.create_element("span",((cljs.core.map_QMARK_(attrs48501))?daiquiri.interpreter.element_attributes(attrs48501):null),((cljs.core.map_QMARK_(attrs48501))?null:[daiquiri.interpreter.interpret(attrs48501)]));
...
var vec__48511 = translations.root._ttt(rum.core.react(predict_prostate.state.run_time.ttt_cursor),arg);
var lang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48511,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48511,(1),null);
...
return daiquiri.core.create_element("span",{'style':{'backgroundColor':"#e488",'color':"#fff",'border':"1px dashed #e48"},'onClick':(function (p1__48506_SHARP_){
predict_prostate.state.run_time.edit_change.pubsub$feeds$TopicFeed$publish$arity$2(null,arg);

return p1__48506_SHARP_.stopPropagation();
})},[daiquiri.interpreter.interpret(text)]);
} else {
return daiquiri.core.create_element("span",{'style':{'backgroundColor':"#e482",'minWidth':"1ex",'minHeight':"10px",'border':((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(text,""))?"1px solid red":"1px solid #ccc")},'onClick':(function (p1__48507_SHARP_){
predict_prostate.state.run_time.edit_change.pubsub$feeds$TopicFeed$publish$arity$2(null,arg);

return p1__48507_SHARP_.stopPropagation();
})},[daiquiri.interpreter.interpret(text)]);
}
