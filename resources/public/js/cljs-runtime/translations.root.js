...
var vec__41789 = translations.root._ttt(rum.core.react(predict_prostate.state.run_time.ttt_cursor),arg);
var lang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41789,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41789,(1),null);
var attrs41788 = text;
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(React.createElement,"span",((cljs.core.map_QMARK_(attrs41788))?sablono.interpreter.attributes(attrs41788):null),((cljs.core.map_QMARK_(attrs41788))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret(attrs41788)], null)));
...
var vec__41794 = translations.root._ttt(rum.core.react(predict_prostate.state.run_time.ttt_cursor),arg);
var lang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41794,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41794,(1),null);
...
return React.createElement("span",({"style": ({"backgroundColor": "#e488", "color": "#fff", "border": "1px dashed #e48"}), "onClick": (function (p1__41792_SHARP_){
predict_prostate.state.run_time.edit_change.pubsub$feeds$TopicFeed$publish$arity$2(null,arg);

return p1__41792_SHARP_.stopPropagation();
})}),sablono.interpreter.interpret(text));
} else {
return React.createElement("span",({"style": ({"backgroundColor": "#e482", "minWidth": "1ex", "minHeight": "10px", "border": ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(text,""))?"1px solid red":"1px solid #ccc")}), "onClick": (function (p1__41793_SHARP_){
predict_prostate.state.run_time.edit_change.pubsub$feeds$TopicFeed$publish$arity$2(null,arg);

return p1__41793_SHARP_.stopPropagation();
})}),sablono.interpreter.interpret(text));
}
