...
var vec__35003 = translations.root._ttt(rum.core.react(predict_prostate.state.run_time.ttt_cursor),arg);
var lang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35003,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35003,(1),null);
var attrs35002 = text;
return daiquiri.core.create_element("span",((cljs.core.map_QMARK_(attrs35002))?daiquiri.interpreter.element_attributes(attrs35002):null),((cljs.core.map_QMARK_(attrs35002))?null:[daiquiri.interpreter.interpret(attrs35002)]));
...
var vec__35008 = translations.root._ttt(rum.core.react(predict_prostate.state.run_time.ttt_cursor),arg);
var lang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35008,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35008,(1),null);
...
return daiquiri.core.create_element("span",{'style':{'backgroundColor':"#e488",'color':"#fff",'border':"1px dashed #e48"},'onClick':(function (p1__35006_SHARP_){
predict_prostate.state.run_time.edit_change.pubsub$feeds$TopicFeed$publish$arity$2(null,arg);

return p1__35006_SHARP_.stopPropagation();
})},[daiquiri.interpreter.interpret(text)]);
} else {
return daiquiri.core.create_element("span",{'style':{'backgroundColor':"#e482",'minWidth':"1ex",'minHeight':"10px",'border':((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(text,""))?"1px solid red":"1px solid #ccc")},'onClick':(function (p1__35007_SHARP_){
predict_prostate.state.run_time.edit_change.pubsub$feeds$TopicFeed$publish$arity$2(null,arg);

return p1__35007_SHARP_.stopPropagation();
})},[daiquiri.interpreter.interpret(text)]);
}
