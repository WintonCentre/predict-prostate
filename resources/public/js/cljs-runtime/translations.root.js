...
var vec__34986 = translations.root._ttt(rum.core.react(predict_prostate.state.run_time.ttt_cursor),arg);
var lang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34986,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34986,(1),null);
var attrs34984 = text;
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(React.createElement,"span",((cljs.core.map_QMARK_(attrs34984))?sablono.interpreter.attributes(attrs34984):null),((cljs.core.map_QMARK_(attrs34984))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret(attrs34984)], null)));
...
var vec__34994 = translations.root._ttt(rum.core.react(predict_prostate.state.run_time.ttt_cursor),arg);
var lang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34994,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34994,(1),null);
...
return React.createElement("span",({"style": ({"backgroundColor": "#e488", "color": "#fff", "border": "1px dashed #e48"}), "onClick": (function (p1__34992_SHARP_){
predict_prostate.state.run_time.edit_change.pubsub$feeds$TopicFeed$publish$arity$2(null,arg);

return p1__34992_SHARP_.stopPropagation();
})}),sablono.interpreter.interpret(text));
} else {
return React.createElement("span",({"style": ({"backgroundColor": "#e482", "display": "inline-block", "minWidth": "1ex", "minHeight": "10px", "border": ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(text,""))?"1px solid red":"1px solid #ccc")}), "onClick": (function (p1__34993_SHARP_){
predict_prostate.state.run_time.edit_change.pubsub$feeds$TopicFeed$publish$arity$2(null,arg);

return p1__34993_SHARP_.stopPropagation();
})}),sablono.interpreter.interpret(text));
}
