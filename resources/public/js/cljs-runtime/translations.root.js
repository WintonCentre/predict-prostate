...
var vec__49419 = translations.root._ttt(rum.core.react(predict_prostate.state.run_time.ttt_cursor),arg);
var lang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49419,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49419,(1),null);
var attrs49418 = text;
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(React.createElement,"span",((cljs.core.map_QMARK_(attrs49418))?sablono.interpreter.attributes(attrs49418):null),((cljs.core.map_QMARK_(attrs49418))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret(attrs49418)], null)));
...
var vec__49424 = translations.root._ttt(rum.core.react(predict_prostate.state.run_time.ttt_cursor),arg);
var lang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49424,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49424,(1),null);
...
return React.createElement("span",({"style": ({"backgroundColor": "#e488", "color": "#fff", "border": "1px dashed #e48"}), "onClick": (function (p1__49422_SHARP_){
predict_prostate.state.run_time.edit_change.pubsub$feeds$TopicFeed$publish$arity$2(null,arg);

return p1__49422_SHARP_.stopPropagation();
})}),sablono.interpreter.interpret(text));
} else {
return React.createElement("span",({"style": ({"backgroundColor": "#e482", "minWidth": "1ex", "minHeight": "10px", "border": ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(text,""))?"1px solid red":"1px solid #ccc")}), "onClick": (function (p1__49423_SHARP_){
predict_prostate.state.run_time.edit_change.pubsub$feeds$TopicFeed$publish$arity$2(null,arg);

return p1__49423_SHARP_.stopPropagation();
})}),sablono.interpreter.interpret(text));
}
