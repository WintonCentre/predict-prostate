...
predict_prostate.layout.navbar.clear_all_button = rum.core.lazy_build(rum.core.build_defc,(function (p__33529){
var map__33530 = p__33529;
var map__33530__$1 = cljs.core.__destructure_map(map__33530);
var props = map__33530__$1;
var ttt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33530__$1,new cljs.core.Keyword(null,"ttt","ttt",1858561240));
var on_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33530__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543));
return daiquiri.core.create_element("button",{'onClick':on_click,'className':"btn navbar-btn btn-danger btn-lg"},[" ",daiquiri.interpreter.interpret((function (){var G__33532 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("tool","reset-btn","tool/reset-btn",-2075589013),"Reset"], null);
