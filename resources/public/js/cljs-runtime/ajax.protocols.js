...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_42757 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_42757(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_42758 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_42758(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_42759 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_42759(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_42760 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_42760(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_42761 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_42761(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_42763 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_42763(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_42764 = (function (this$,header){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_42764(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_42768 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_42768(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_42771 = (function (this$,request){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_42771(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_42772 = (function (this$,response){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_42772(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4463__auto__,k42655,else__4464__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k42655,else__4464__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4484__auto__,p__42676){
var vec__42677 = p__42676;
var k__4485__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42677,(0),null);
var v__4486__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42677,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__42654){
var self__ = this;
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this42656,other42657){
var self__ = this;
var this42656__$1 = this;
return (((!((other42657 == null)))) && ((((this42656__$1.constructor === other42657.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this42656__$1.status,other42657.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this42656__$1.body,other42657.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this42656__$1.status_text,other42657.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this42656__$1.headers,other42657.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this42656__$1.was_aborted,other42657.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this42656__$1.__extmap,other42657.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4468__auto__,k42655){
var self__ = this;
var this__4468__auto____$1 = this;
var G__42735 = k42655;
var G__42735__$1 = (((G__42735 instanceof cljs.core.Keyword))?G__42735.fqn:null);
switch (G__42735__$1) {
case "status":
case "body":
case "status-text":
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4469__auto__,k__4470__auto__,G__42654){
var self__ = this;
var this__4469__auto____$1 = this;
var pred__42738 = cljs.core.keyword_identical_QMARK_;
var expr__42739 = k__4470__auto__;
if(cljs.core.truth_((pred__42738.cljs$core$IFn$_invoke$arity$2 ? pred__42738.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__42739) : pred__42738.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__42739)))){
return (new ajax.protocols.Response(G__42654,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__42738.cljs$core$IFn$_invoke$arity$2 ? pred__42738.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__42739) : pred__42738.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__42739)))){
return (new ajax.protocols.Response(self__.status,G__42654,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__42738.cljs$core$IFn$_invoke$arity$2 ? pred__42738.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__42739) : pred__42738.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__42739)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__42654,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__42738.cljs$core$IFn$_invoke$arity$2 ? pred__42738.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__42739) : pred__42738.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__42739)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__42654,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__42738.cljs$core$IFn$_invoke$arity$2 ? pred__42738.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__42739) : pred__42738.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__42739)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__42654,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4470__auto__,G__42654),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4460__auto__,G__42654){
var self__ = this;
var this__4460__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__42654,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__42659){
var extmap__4501__auto__ = (function (){var G__42752 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__42659,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__42659)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__42752);
} else {
return G__42752;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__42659),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__42659),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__42659),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__42659),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__42659),null,cljs.core.not_empty(extmap__4501__auto__),null));
});
