...
predict_prostate.components.bs3_navbar.collapsing_navbar = rum.core.lazy_build(rum.core.build_defc,(function (p__55262,navbar_menu){
var map__55263 = p__55262;
var map__55263__$1 = cljs.core.__destructure_map(map__55263);
var props = map__55263__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55263__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
predict_prostate.components.bs3_navbar.navbar = rum.core.lazy_build(rum.core.build_defc,(function (p__55265,navbar_menu){
var map__55267 = p__55265;
var map__55267__$1 = cljs.core.__destructure_map(map__55267);
var props = map__55267__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55267__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var class_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55267__$1,new cljs.core.Keyword(null,"class-name","class-name",945142584));
var logo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55267__$1,new cljs.core.Keyword(null,"logo","logo",1237980263));
...
(predict_prostate.components.bs3_navbar.Nav_item.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4463__auto__,k55275,else__4464__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k55275,else__4464__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4484__auto__,p__55304){
var vec__55305 = p__55304;
var k__4485__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55305,(0),null);
var v__4486__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55305,(1),null);
...
(predict_prostate.components.bs3_navbar.Nav_item.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__55274){
var self__ = this;
...
(predict_prostate.components.bs3_navbar.Nav_item.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this55276,other55277){
var self__ = this;
var this55276__$1 = this;
return (((!((other55277 == null)))) && ((((this55276__$1.constructor === other55277.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this55276__$1.text,other55277.text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this55276__$1.on_click,other55277.on_click)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this55276__$1.target,other55277.target)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this55276__$1.__extmap,other55277.__extmap)))))))))));
}));
...
(predict_prostate.components.bs3_navbar.Nav_item.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4468__auto__,k55275){
var self__ = this;
var this__4468__auto____$1 = this;
var G__55317 = k55275;
var G__55317__$1 = (((G__55317 instanceof cljs.core.Keyword))?G__55317.fqn:null);
switch (G__55317__$1) {
case "text":
case "on-click":
case "target":
...
(predict_prostate.components.bs3_navbar.Nav_item.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4469__auto__,k__4470__auto__,G__55274){
var self__ = this;
var this__4469__auto____$1 = this;
var pred__55321 = cljs.core.keyword_identical_QMARK_;
var expr__55322 = k__4470__auto__;
if(cljs.core.truth_((pred__55321.cljs$core$IFn$_invoke$arity$2 ? pred__55321.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"text","text",-1790561697),expr__55322) : pred__55321.call(null,new cljs.core.Keyword(null,"text","text",-1790561697),expr__55322)))){
return (new predict_prostate.components.bs3_navbar.Nav_item(G__55274,self__.on_click,self__.target,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__55321.cljs$core$IFn$_invoke$arity$2 ? pred__55321.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"on-click","on-click",1632826543),expr__55322) : pred__55321.call(null,new cljs.core.Keyword(null,"on-click","on-click",1632826543),expr__55322)))){
return (new predict_prostate.components.bs3_navbar.Nav_item(self__.text,G__55274,self__.target,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__55321.cljs$core$IFn$_invoke$arity$2 ? pred__55321.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"target","target",253001721),expr__55322) : pred__55321.call(null,new cljs.core.Keyword(null,"target","target",253001721),expr__55322)))){
return (new predict_prostate.components.bs3_navbar.Nav_item(self__.text,self__.on_click,G__55274,self__.__meta,self__.__extmap,null));
} else {
return (new predict_prostate.components.bs3_navbar.Nav_item(self__.text,self__.on_click,self__.target,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4470__auto__,G__55274),null));
}
}
}
}));
...
(predict_prostate.components.bs3_navbar.Nav_item.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4460__auto__,G__55274){
var self__ = this;
var this__4460__auto____$1 = this;
return (new predict_prostate.components.bs3_navbar.Nav_item(self__.text,self__.on_click,self__.target,G__55274,self__.__extmap,self__.__hash));
}));
 ...
 */
predict_prostate.components.bs3_navbar.map__GT_Nav_item = (function predict_prostate$components$bs3_navbar$map__GT_Nav_item(G__55282){
var extmap__4501__auto__ = (function (){var G__55335 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__55282,new cljs.core.Keyword(null,"text","text",-1790561697),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"on-click","on-click",1632826543),new cljs.core.Keyword(null,"target","target",253001721)], 0));
if(cljs.core.record_QMARK_(G__55282)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__55335);
} else {
return G__55335;
}
})();
return (new predict_prostate.components.bs3_navbar.Nav_item(new cljs.core.Keyword(null,"text","text",-1790561697).cljs$core$IFn$_invoke$arity$1(G__55282),new cljs.core.Keyword(null,"on-click","on-click",1632826543).cljs$core$IFn$_invoke$arity$1(G__55282),new cljs.core.Keyword(null,"target","target",253001721).cljs$core$IFn$_invoke$arity$1(G__55282),null,cljs.core.not_empty(extmap__4501__auto__),null));
});
...
predict_prostate.components.bs3_navbar.make_nav_item = (function predict_prostate$components$bs3_navbar$make_nav_item(key,rt,p__55341){
var map__55342 = p__55341;
var map__55342__$1 = cljs.core.__destructure_map(map__55342);
var item = map__55342__$1;
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55342__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var on_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55342__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543));
var target = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55342__$1,new cljs.core.Keyword(null,"target","target",253001721));
var submenus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55342__$1,new cljs.core.Keyword(null,"submenus","submenus",-1749389225));
...
})], null),text,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.caret","span.caret",-1405994877)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul.dropdown-menu","ul.dropdown-menu",-867384656),cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__55338_SHARP_,p2__55339_SHARP_){
return (predict_prostate.components.bs3_navbar.make_nav_item.cljs$core$IFn$_invoke$arity$3 ? predict_prostate.components.bs3_navbar.make_nav_item.cljs$core$IFn$_invoke$arity$3(p1__55338_SHARP_,rt,p2__55339_SHARP_) : predict_prostate.components.bs3_navbar.make_nav_item.call(null,p1__55338_SHARP_,rt,p2__55339_SHARP_));
}),submenus)], null)], null);
} else {
...
predict_prostate.components.bs3_navbar.simple_navbar = rum.core.lazy_build(rum.core.build_defc,(function (p__55377){
var vec__55378 = p__55377;
var menu_items = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55378,(0),null);
var rt = rum.core.react(predict_prostate.state.run_time.route);
return predict_prostate.components.bs3_navbar.navbar(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),"navbar",new cljs.core.Keyword(null,"class-name","class-name",945142584),"navbar-inverse",new cljs.core.Keyword(null,"logo","logo",1237980263),null], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul.nav.navbar-nav","ul.nav.navbar-nav",1805559761),cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__55375_SHARP_,p2__55376_SHARP_){
return predict_prostate.components.bs3_navbar.make_nav_item(p1__55375_SHARP_,rt,p2__55376_SHARP_);
}),menu_items)], null));
