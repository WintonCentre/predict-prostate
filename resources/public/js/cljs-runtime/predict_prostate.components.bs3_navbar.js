...
predict_prostate.components.bs3_navbar.collapsing_navbar = rum.core.build_defc((function (p__46071,navbar_menu){
...
var props = map__46072__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46072__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
predict_prostate.components.bs3_navbar.navbar = rum.core.build_defc((function (p__46077,navbar_menu){
...
var props = map__46078__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46078__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var class_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46078__$1,new cljs.core.Keyword(null,"class-name","class-name",945142584));
var logo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46078__$1,new cljs.core.Keyword(null,"logo","logo",1237980263));
...
}),cljs.core.range.cljs$core$IFn$_invoke$arity$1((3))))),sablono.interpreter.interpret((cljs.core.truth_(logo)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"img.navbar-brand","img.navbar-brand",-283247648),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"src","src",-1651076051),logo,new cljs.core.Keyword(null,"alt","alt",-3214426),"logo"], null)], null):null))),sablono.interpreter.interpret((function (){var G__46080 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),id], null);
var G__46081 = navbar_menu;
return (predict_prostate.components.bs3_navbar.collapsing_navbar.cljs$core$IFn$_invoke$arity$2 ? predict_prostate.components.bs3_navbar.collapsing_navbar.cljs$core$IFn$_invoke$arity$2(G__46080,G__46081) : predict_prostate.components.bs3_navbar.collapsing_navbar.call(null,G__46080,G__46081));
})())));
}),null,"navbar");
...
(predict_prostate.components.bs3_navbar.Nav_item.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k46084,else__4383__auto__){
var self__ = this;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__46097){
var vec__46098 = p__46097;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46098,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46098,(1),null);
...
(predict_prostate.components.bs3_navbar.Nav_item.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this46085,other46086){
var self__ = this;
var this46085__$1 = this;
return (((!((other46086 == null)))) && ((this46085__$1.constructor === other46086.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46085__$1.text,other46086.text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46085__$1.on_click,other46086.on_click)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46085__$1.target,other46086.target)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46085__$1.__extmap,other46086.__extmap)));
}));
...
(predict_prostate.components.bs3_navbar.Nav_item.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__46083){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__46109 = cljs.core.keyword_identical_QMARK_;
var expr__46110 = k__4388__auto__;
if(cljs.core.truth_((pred__46109.cljs$core$IFn$_invoke$arity$2 ? pred__46109.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"text","text",-1790561697),expr__46110) : pred__46109.call(null,new cljs.core.Keyword(null,"text","text",-1790561697),expr__46110)))){
return (new predict_prostate.components.bs3_navbar.Nav_item(G__46083,self__.on_click,self__.target,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__46109.cljs$core$IFn$_invoke$arity$2 ? pred__46109.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"on-click","on-click",1632826543),expr__46110) : pred__46109.call(null,new cljs.core.Keyword(null,"on-click","on-click",1632826543),expr__46110)))){
return (new predict_prostate.components.bs3_navbar.Nav_item(self__.text,G__46083,self__.target,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__46109.cljs$core$IFn$_invoke$arity$2 ? pred__46109.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"target","target",253001721),expr__46110) : pred__46109.call(null,new cljs.core.Keyword(null,"target","target",253001721),expr__46110)))){
return (new predict_prostate.components.bs3_navbar.Nav_item(self__.text,self__.on_click,G__46083,self__.__meta,self__.__extmap,null));
} else {
return (new predict_prostate.components.bs3_navbar.Nav_item(self__.text,self__.on_click,self__.target,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__46083),null));
}
}
}
}));
...
(predict_prostate.components.bs3_navbar.Nav_item.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__46083){
var self__ = this;
var this__4379__auto____$1 = this;
return (new predict_prostate.components.bs3_navbar.Nav_item(self__.text,self__.on_click,self__.target,G__46083,self__.__extmap,self__.__hash));
}));
 ...
 */
predict_prostate.components.bs3_navbar.map__GT_Nav_item = (function predict_prostate$components$bs3_navbar$map__GT_Nav_item(G__46087){
var extmap__4419__auto__ = (function (){var G__46115 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__46087,new cljs.core.Keyword(null,"text","text",-1790561697),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"on-click","on-click",1632826543),new cljs.core.Keyword(null,"target","target",253001721)], 0));
if(cljs.core.record_QMARK_(G__46087)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__46115);
} else {
return G__46115;
}
})();
return (new predict_prostate.components.bs3_navbar.Nav_item(new cljs.core.Keyword(null,"text","text",-1790561697).cljs$core$IFn$_invoke$arity$1(G__46087),new cljs.core.Keyword(null,"on-click","on-click",1632826543).cljs$core$IFn$_invoke$arity$1(G__46087),new cljs.core.Keyword(null,"target","target",253001721).cljs$core$IFn$_invoke$arity$1(G__46087),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
predict_prostate.components.bs3_navbar.make_nav_item = (function predict_prostate$components$bs3_navbar$make_nav_item(key,rt,p__46126){
...
var item = map__46127__$1;
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46127__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var on_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46127__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543));
var target = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46127__$1,new cljs.core.Keyword(null,"target","target",253001721));
var submenus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46127__$1,new cljs.core.Keyword(null,"submenus","submenus",-1749389225));
...
})], null),text,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.caret","span.caret",-1405994877)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul.dropdown-menu","ul.dropdown-menu",-867384656),cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__46123_SHARP_,p2__46124_SHARP_){
return (predict_prostate.components.bs3_navbar.make_nav_item.cljs$core$IFn$_invoke$arity$3 ? predict_prostate.components.bs3_navbar.make_nav_item.cljs$core$IFn$_invoke$arity$3(p1__46123_SHARP_,rt,p2__46124_SHARP_) : predict_prostate.components.bs3_navbar.make_nav_item.call(null,p1__46123_SHARP_,rt,p2__46124_SHARP_));
}),submenus)], null)], null);
} else {
...
predict_prostate.components.bs3_navbar.simple_navbar = rum.core.build_defc((function (p__46142){
var vec__46143 = p__46142;
var menu_items = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46143,(0),null);
var rt = rum.core.react(predict_prostate.state.run_time.route);
return sablono.interpreter.interpret((function (){var G__46146 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),"navbar",new cljs.core.Keyword(null,"class-name","class-name",945142584),"navbar-inverse",new cljs.core.Keyword(null,"logo","logo",1237980263),null], null);
var G__46147 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul.nav.navbar-nav","ul.nav.navbar-nav",1805559761),cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__46140_SHARP_,p2__46141_SHARP_){
return predict_prostate.components.bs3_navbar.make_nav_item(p1__46140_SHARP_,rt,p2__46141_SHARP_);
}),menu_items)], null);
return (predict_prostate.components.bs3_navbar.navbar.cljs$core$IFn$_invoke$arity$2 ? predict_prostate.components.bs3_navbar.navbar.cljs$core$IFn$_invoke$arity$2(G__46146,G__46147) : predict_prostate.components.bs3_navbar.navbar.call(null,G__46146,G__46147));
})());
...
var attrs46154 = (function (){var G__46155 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [predict_prostate.components.bs3_navbar.nav_items], null);
return (predict_prostate.components.bs3_navbar.simple_navbar.cljs$core$IFn$_invoke$arity$1 ? predict_prostate.components.bs3_navbar.simple_navbar.cljs$core$IFn$_invoke$arity$1(G__46155) : predict_prostate.components.bs3_navbar.simple_navbar.call(null,G__46155));
})();
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(React.createElement,"nav",((cljs.core.map_QMARK_(attrs46154))?sablono.interpreter.attributes(attrs46154):null),((cljs.core.map_QMARK_(attrs46154))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret(attrs46154)], null)));
