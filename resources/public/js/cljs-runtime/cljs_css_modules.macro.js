...
cljs_css_modules.macro.localise_selector = (function cljs_css_modules$macro$localise_selector(id,selector,p__45943){
var map__45944 = p__45943;
var map__45944__$1 = cljs.core.__destructure_map(map__45944);
var regexp = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45944__$1,new cljs.core.Keyword(null,"regexp","regexp",-541372782));
var localise_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45944__$1,new cljs.core.Keyword(null,"localise-fn","localise-fn",-375044382));
 ...
 */
cljs_css_modules.macro.get_selector_key = (function cljs_css_modules$macro$get_selector_key(selector,p__45946){
var map__45947 = p__45946;
var map__45947__$1 = cljs.core.__destructure_map(map__45947);
var regexp = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45947__$1,new cljs.core.Keyword(null,"regexp","regexp",-541372782));
var name_template = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45947__$1,new cljs.core.Keyword(null,"name-template","name-template",1677383261));
 ...
 */
cljs_css_modules.macro.get_selector_value = (function cljs_css_modules$macro$get_selector_value(selector,p__45950){
var map__45951 = p__45950;
var map__45951__$1 = cljs.core.__destructure_map(map__45951);
var regexp = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45951__$1,new cljs.core.Keyword(null,"regexp","regexp",-541372782));
var value_template = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45951__$1,new cljs.core.Keyword(null,"value-template","value-template",10903298));
return cljs.core.name(clojure.string.replace(selector,regexp,value_template));
});
cljs_css_modules.macro.is_media_QMARK_ = (function cljs_css_modules$macro$is_media_QMARK_(p__45956){
var vec__45957 = p__45956;
...
var first = first__45959;
var rest = seq__45958__$1;
var style = vec__45957;
...
cljs_css_modules.macro.is_keyframe_QMARK_ = (function cljs_css_modules$macro$is_keyframe_QMARK_(p__45963){
...
var first = first__45966;
var rest = seq__45965__$1;
var style = vec__45964;
...
cljs_css_modules.macro.process_style = (function cljs_css_modules$macro$process_style(id,p__45971){
var vec__45972 = p__45971;
var seq__45973 = cljs.core.seq(vec__45972);
var first__45974 = cljs.core.first(seq__45973);
var seq__45973__$1 = cljs.core.next(seq__45973);
var fst = first__45974;
var rest = seq__45973__$1;
var style = vec__45972;
if(cljs_css_modules.macro.is_keyframe_QMARK_(style)){
var vec__45975 = style;
...
var symbol = first__45977;
var first__45977__$1 = cljs.core.first(seq__45976__$1);
var seq__45976__$2 = cljs.core.next(seq__45976__$1);
var name = first__45977__$1;
var style__$1 = seq__45976__$2;
...
var symbol = first__45980;
var first__45980__$1 = cljs.core.first(seq__45979__$1);
var seq__45979__$2 = cljs.core.next(seq__45979__$1);
var params = first__45980__$1;
var style__$1 = seq__45979__$2;
...
cljs_css_modules.macro.create_garden_style = (function cljs_css_modules$macro$create_garden_style(id,p__45981,item){
var map__45982 = p__45981;
var map__45982__$1 = cljs.core.__destructure_map(map__45982);
var acc = map__45982__$1;
var map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45982__$1,new cljs.core.Keyword(null,"map","map",1371690461));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45982__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
var map__45983 = cljs_css_modules.macro.process_style(id,item);
var map__45983__$1 = cljs.core.__destructure_map(map__45983);
var item__$1 = map__45983__$1;
var selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45983__$1,new cljs.core.Keyword(null,"selector","selector",762528866));
var garden_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45983__$1,new cljs.core.Keyword(null,"garden-style","garden-style",334433186));
var nested_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45983__$1,new cljs.core.Keyword(null,"nested-style","nested-style",2061569038));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45983__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45983__$1,new cljs.core.Keyword(null,"params","params",710516235));
var style_object_value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45983__$1,new cljs.core.Keyword(null,"style-object-value","style-object-value",1882769999));
var G__45984 = type;
...
break;
case "media":
var map__45986 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_css_modules.macro.create_garden_style,id),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"style","style",-496642736),cljs.core.PersistentVector.EMPTY], null),nested_style);
var map__45986__$1 = cljs.core.__destructure_map(map__45986);
var s = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45986__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45986__$1,new cljs.core.Keyword(null,"map","map",1371690461));
