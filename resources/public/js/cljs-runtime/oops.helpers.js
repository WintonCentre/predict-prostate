...
var G__36091 = cljs.core.next(items);
items = G__36091;
continue;
} else {
return arr;
...
var x36066 = error;
(x36066.cljs$core$IPrintWithWriter$ = cljs.core.PROTOCOL_SENTINEL);

(x36066.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (_obj,writer,opts){
var _obj__$1 = this;
...
var G__36095 = Object.getPrototypeOf(o);
o = G__36095;
continue;
} else {
