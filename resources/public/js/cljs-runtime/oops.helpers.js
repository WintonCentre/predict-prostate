...
var G__44422 = cljs.core.next(items);
items = G__44422;
continue;
} else {
return arr;
...
var x44410 = error;
(x44410.cljs$core$IPrintWithWriter$ = cljs.core.PROTOCOL_SENTINEL);

(x44410.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (_obj,writer,opts){
var _obj__$1 = this;
...
var G__44424 = Object.getPrototypeOf(o);
o = G__44424;
continue;
} else {
